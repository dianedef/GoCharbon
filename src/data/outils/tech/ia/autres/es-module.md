...
**[<img alt="Code showing variables being manipulated" src="https://hacks.mozilla.org/wp-content/uploads/2018/03/01_variables-500x178.png" height="178" width="500" />](https://hacks.mozilla.org/wp-content/uploads/2018/03/01_variables.png)**
...
[<img alt="Two function scopes with one trying to reach into another but failing" src="https://hacks.mozilla.org/wp-content/uploads/2018/03/02_module_scope_01-500x292.png" height="292" width="500" />](https://hacks.mozilla.org/wp-content/uploads/2018/03/02_module_scope_01.png)
...
[<img alt="Two function scopes in a global, with one putting jQuery into the global" src="https://hacks.mozilla.org/wp-content/uploads/2018/03/02_module_scope_02-500x450.png" height="450" width="500" />](https://hacks.mozilla.org/wp-content/uploads/2018/03/02_module_scope_02.png)
...
[<img alt="The top function scope has been removed and now the second function scope can’t find jQuery on the global" src="https://hacks.mozilla.org/wp-content/uploads/2018/03/02_module_scope_03-500x450.png" height="450" width="500" />](https://hacks.mozilla.org/wp-content/uploads/2018/03/02_module_scope_03.png)
...
[<img alt="Two module scopes, with one reaching into the other to grab an export" src="https://hacks.mozilla.org/wp-content/uploads/2018/03/02_module_scope_04-500x450.png" height="450" width="500" />](https://hacks.mozilla.org/wp-content/uploads/2018/03/02_module_scope_04.png)
...
[<img alt="A module with two dependencies. The top module is the entry. The other two are related using import statements" src="https://hacks.mozilla.org/wp-content/uploads/2018/03/04_import_graph-500x291.png" height="291" width="500" />](https://hacks.mozilla.org/wp-content/uploads/2018/03/04_import_graph.png)
...
[<img alt="A module record with various fields, including RequestedModules and ImportEntries" src="https://hacks.mozilla.org/wp-content/uploads/2018/03/05_module_record-500x287.png" height="287" width="500" />](https://hacks.mozilla.org/wp-content/uploads/2018/03/05_module_record.png)
...
[<img alt="A module instance combining code and state" src="https://hacks.mozilla.org/wp-content/uploads/2018/03/06_module_instance-500x372.png" height="372" width="500" />](https://hacks.mozilla.org/wp-content/uploads/2018/03/06_module_instance.png)
...
[<img alt="The three phases. Construction goes from a single JS file to multiple module records. Instantiation links those records. Evaluation executes the code." src="https://hacks.mozilla.org/wp-content/uploads/2018/03/07_3_phases-500x184.png" height="184" width="500" />](https://hacks.mozilla.org/wp-content/uploads/2018/03/07_3_phases.png)
...
[<img alt="Two cartoon figures. One represents the spec that says how to load modules (i.e., the HTML spec). The other represents the ES module spec." src="https://hacks.mozilla.org/wp-content/uploads/2018/03/07_loader_vs_es-500x286.png" height="286" width="500" />](https://hacks.mozilla.org/wp-content/uploads/2018/03/07_loader_vs_es.png)
...
[<img alt="The loader figure acting as a puppeteer to the ES module spec figure." src="https://hacks.mozilla.org/wp-content/uploads/2018/03/08_loader_as_puppeteer-500x330.png" height="330" width="500" />](https://hacks.mozilla.org/wp-content/uploads/2018/03/08_loader_as_puppeteer.png)
...
[<img alt="A script tag with the type=module attribute and a src URL. The src URL has a file coming from it which is the entry" src="https://hacks.mozilla.org/wp-content/uploads/2018/03/08_script_entry-500x188.png" height="188" width="500" />](https://hacks.mozilla.org/wp-content/uploads/2018/03/08_script_entry.png)
...
[<img alt="An import statement with the URL at the end labeled as the module specifier" src="https://hacks.mozilla.org/wp-content/uploads/2018/03/09_module_specifier-500x105.png" height="105" width="500" />](https://hacks.mozilla.org/wp-content/uploads/2018/03/09_module_specifier.png)
...
[<img alt="A diagram that shows one file being fetched and then parsed, and then two more files being fetched and then parsed" src="https://hacks.mozilla.org/wp-content/uploads/2018/03/10_construction-500x302.png" height="302" width="500" />](https://hacks.mozilla.org/wp-content/uploads/2018/03/10_construction.png)
...
<img alt="A chart of latencies showing that if a CPU cycle took 1 second, then main memory access would take 6 minutes, and fetching a file from a server across the US would take 4 years" src="https://hacks.mozilla.org/wp-content/uploads/2018/03/11_latency-500x270.png" height="270" width="500" />Based on [this chart](https://twitter.com/srigi/status/917998817051541504).
...
[<img alt="A diagram showing a Node module evaluating up to a require statement, and then Node going to synchronously load and evaluate the module and any of its dependencies" src="https://hacks.mozilla.org/wp-content/uploads/2018/03/12_cjs_require-500x298.png" height="298" width="500" />](https://hacks.mozilla.org/wp-content/uploads/2018/03/12_cjs_require.png)
...
[<img alt="A require statement which uses a variable is fine. An import statement that uses a variable is not." src="https://hacks.mozilla.org/wp-content/uploads/2018/03/13_static_import-500x146.png" height="146" width="500" />](https://hacks.mozilla.org/wp-content/uploads/2018/03/13_static_import.png)
...
[<img alt="Two module graphs with a dependency between them, labeled with a dynamic import statement" src="https://hacks.mozilla.org/wp-content/uploads/2018/03/14dynamic_import_graph-500x389.png" height="389" width="500" />](https://hacks.mozilla.org/wp-content/uploads/2018/03/14dynamic_import_graph.png)
...
[<img alt="The loader figure filling in a Module Map chart, with the URL of the main module on the left and the word fetching being filled in on the right" src="https://hacks.mozilla.org/wp-content/uploads/2018/03/15_module_map-500x170.png" height="170" width="500" />](https://hacks.mozilla.org/wp-content/uploads/2018/03/15_module_map.png)
...
[<img alt="Diagram showing main.js file being parsed into a module record" src="https://hacks.mozilla.org/wp-content/uploads/2018/03/25_file_to_module_record-500x199.png" height="199" width="500" />](https://hacks.mozilla.org/wp-content/uploads/2018/03/25_file_to_module_record.png)
...
[<img alt="The “fetching” placeholders in the module map chart being filled in with module records" src="https://hacks.mozilla.org/wp-content/uploads/2018/03/25_module_map-500x239.png" height="239" width="500" />](https://hacks.mozilla.org/wp-content/uploads/2018/03/25_module_map.png)
...
[<img alt="The loader determining that main.js is a module because the type attribute on the script tag says so, and counter.js must be a module because it’s imported" src="https://hacks.mozilla.org/wp-content/uploads/2018/03/26_parse_goal-500x311.png" height="311" width="500" />](https://hacks.mozilla.org/wp-content/uploads/2018/03/26_parse_goal.png)
...
[<img alt="A JS file on the left, with 3 parsed module records on the right as a result of the construction phase" src="https://hacks.mozilla.org/wp-content/uploads/2018/03/27_construction-500x406.png" height="406" width="500" />](https://hacks.mozilla.org/wp-content/uploads/2018/03/27_construction.png)
...
[<img alt="A column of empty memory in the middle. Module environment records for the count and display modules are wired up to boxes in memory." src="https://hacks.mozilla.org/wp-content/uploads/2018/03/30_live_bindings_01-500x206.png" height="206" width="500" />](https://hacks.mozilla.org/wp-content/uploads/2018/03/30_live_bindings_01.png)
...
[<img alt="Same diagram as above, but with the module environment record for main.js now having its imports linked up to the exports from the other two modules." src="https://hacks.mozilla.org/wp-content/uploads/2018/03/30_live_bindings_02-500x206.png" height="206" width="500" />](https://hacks.mozilla.org/wp-content/uploads/2018/03/30_live_bindings_02.png)
...
[<img alt="Memory in the middle with an exporting common JS module pointing to one memory location, then the value being copied to another and the importing JS module pointing to the new location" src="https://hacks.mozilla.org/wp-content/uploads/2018/03/31_cjs_variable-500x113.png" height="113" width="500" />](https://hacks.mozilla.org/wp-content/uploads/2018/03/31_cjs_variable.png)
...
[<img alt="The exporting module changing the value in memory. The importing module also tries but fails." src="https://hacks.mozilla.org/wp-content/uploads/2018/03/30_live_bindings_04-500x206.png" height="206" width="500" />](https://hacks.mozilla.org/wp-content/uploads/2018/03/30_live_bindings_04.png)
...
[<img alt="A module will code outside of functions, labeled top level code" src="https://hacks.mozilla.org/wp-content/uploads/2018/03/40_top_level_code-500x146.png" height="146" width="500" />](https://hacks.mozilla.org/wp-content/uploads/2018/03/40_top_level_code.png)
...
[<img alt="A complex module graph with a 4 module cycle on the left. A simple 2 module cycle on the right." src="https://hacks.mozilla.org/wp-content/uploads/2018/03/41_cjs_cycle-500x224.png" height="224" width="500" />](https://hacks.mozilla.org/wp-content/uploads/2018/03/41_cjs_cycle.png)
...
[<img alt="A commonJS module, with a variable being exported from main.js after a require statement to counter.js, which depends on that import" src="https://hacks.mozilla.org/wp-content/uploads/2018/03/41_cyclic_graph-500x281.png" height="281" width="500" />](https://hacks.mozilla.org/wp-content/uploads/2018/03/41_cyclic_graph.png)
...
[<img alt="Memory in the middle with no connection between main.js and memory, but an importing link from counter.js to a memory location which has undefined" src="https://hacks.mozilla.org/wp-content/uploads/2018/03/42_cjs_variable_2-500x113.png" height="113" width="500" />](https://hacks.mozilla.org/wp-content/uploads/2018/03/42_cjs_variable_2.png)
...
[<img alt="counter.js returning control to main.js, which finishes evaluating" src="https://hacks.mozilla.org/wp-content/uploads/2018/03/43_cjs_cycle-500x224.png" height="224" width="500" />](https://hacks.mozilla.org/wp-content/uploads/2018/03/43_cjs_cycle.png)
...
**[<img alt="main.js getting its export connection to memory and filling in the correct value, but counter.js still pointing to the other memory location with undefined in it" src="https://hacks.mozilla.org/wp-content/uploads/2018/03/44_cjs_variable_2-500x216.png" height="216" width="500" />](https://hacks.mozilla.org/wp-content/uploads/2018/03/44_cjs_variable_2.png)**
