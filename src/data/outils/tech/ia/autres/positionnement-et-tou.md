...
Aussi appelée **carte perceptuelle**, la **carte de positionnemen**t est un outil d’analyse marketing.
...
- **la [segmentation](https://www.appvizer.fr/magazine/marketing/webmarketing/critere-de-segmentation) des clients** : qui sont-ils ? Quel âge ont-ils ? Quels sont leurs besoins ? Cela permet de proposer un produit ou service adapté à la clientèle ;
...
La **pyramide de Keller**, du nom du professeur américain de marketing célèbre pour son ouvrage de référence _Management stratégique de la marque_, permet de représenter le **capital marque** d’une entreprise à travers quatre étapes de développement :

- **l’[identité de la marque](https://www.appvizer.fr/magazine/marketing/gestion-reputation/image-marque)** : tous les éléments qui permettent aux consommateurs d’identifier et de retenir votre marque ;
...
💡 La pyramide de Keller est un outil d’analyse marketing qui permet d’appréhender l’**[expérience client](https://www.appvizer.fr/magazine/relation-client/customer-relationship-management-crm/experience-client)** et d’élaborer des stratégies adaptées.
