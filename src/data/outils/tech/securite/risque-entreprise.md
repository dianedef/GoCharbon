...
Sources : [Shadow GPT : une menace croissante à surveiller](https://blog.lockself.com/shadow-gpt-menace-croissante-a-surveiller)

**Shadow GPT : une menace croissante qui doit être encadrée**

Le Shadow GPT, qui désigne l'utilisation de ChatGPT ou de toute autre intelligence artificielle (IA) générative en entreprise sans l'autorisation du service informatique, est une menace croissante pour les entreprises.

**Les raisons de cette tendance**

Le Shadow GPT est devenu populaire pour plusieurs raisons. Tout d'abord, les IA génératives sont de plus en plus puissantes et accessibles. Elles peuvent être utilisées pour une grande variété de tâches, de la création de contenu à l'automatisation de processus.

Deuxièmement, les collaborateurs sont de plus en plus enclins à utiliser des technologies qui leur permettent de gagner du temps et d'être plus productifs. Les IA génératives peuvent être un outil précieux pour cela.

**Les risques du Shadow GPT**

Le Shadow GPT comporte un certain nombre de risques pour les entreprises, notamment :

* **La perte de contrôle sur les données** : Lorsque les collaborateurs utilisent des IA génératives, ils partagent souvent des données sensibles avec ces outils. Ces données peuvent ensuite être utilisées par des tiers, ce qui peut entraîner des fuites de données ou des cyberattaques.
* **L'obtention d'informations erronées** : Les IA génératives ne sont pas parfaites. Elles peuvent parfois fournir des informations erronées ou biaisées. Cela peut entraîner des problèmes pour l'entreprise, notamment des pertes financières ou une atteinte à la réputation.
* **La non-propriété des réponses ou documents fournis par l'IA** : Dans la plupart des cas, les IA génératives ne sont pas propriétaires des réponses ou documents qu'elles fournissent. Cela signifie que l'entreprise ne peut pas les utiliser librement.

**Comment limiter le Shadow GPT et sécuriser les usages**

Les entreprises doivent prendre des mesures pour limiter le Shadow GPT et sécuriser les usages des IA génératives.

Voici quelques conseils :

* **Encadrer l'utilisation des IA génératives** : Les entreprises doivent mettre en place une politique d'utilisation des IA génératives qui précise les conditions d'utilisation de ces outils. Cette politique doit être communiquée à tous les collaborateurs.
* **Privilégier les modèles payants** : Les modèles payants proposent généralement une meilleure sécurité que les modèles gratuits. Ils garantissent notamment la confidentialité des données et la non-utilisation des données pour entraîner les modèles.
* **Mettre en place des garde-fous** : Les entreprises peuvent mettre en place des garde-fous pour limiter les risques liés aux IA génératives. Par exemple, elles peuvent exiger que les collaborateurs utilisent des modèles payants ou qu'ils vérifient les sources des informations fournies par les IA.

**Conclusion**

Le Shadow GPT est une menace croissante pour les entreprises. Les entreprises doivent prendre des mesures pour limiter ce phénomène et sécuriser les usages des IA génératives.


# The Growing Threat of Shadow GPT: What You Need to Know

**Cybersecurity • 10 min read • August 25, 2023**

You're likely familiar with Shadow IT and its associated risks, but have you heard of Shadow GPT? Let's shine a spotlight on this emerging threat and its inherent dangers!

## What is "Shadow GPT"? 🔍

The term "Shadow GPT" stems from the combination of two phrases. Firstly, "Shadow," borrowed from "Shadow IT," which refers to the use of technologies, software, services, and applications by employees without obtaining prior approval from the company's IT department. Secondly, "GPT," which stands for "Generative Pre-trained Transformer" and refers to the language model developed by OpenAI, famously known for its generative AI, "ChatGPT."

"Shadow GPT" thus involves the use of ChatGPT or any other generative artificial intelligence (AI) in the workplace without obtaining explicit authorization from the IT department.

Shadow GPT is essentially a subset of Shadow IT, with shared risks and additional complexities. Let's dive deeper into the topic.

## Why is "Shadow GPT" on the Rise?

Since the public discovery of ChatGPT in 2023, the proliferation of various generative AIs has been unstoppable. Individuals are increasingly eager to test, have tested, or want to try out ChatGPT and other generative AIs in various business domains.

According to a GetApp study, "70% of surveyed employees have already used AI in their professional activities." Whether it's for entertainment, enhancing work performance, or pushing the boundaries of these powerful tools, generative AI is seeping into every aspect of our lives.

No company is immune to scenarios where:

- The CFO uses ChatGPT to assist in budget forecasting.
- The HR department employs generative AIs to save time on time-consuming tasks like creating new employment contracts.
- A developer uses ChatGPT to review the company's source code for optimization.

Moreover, platforms commonly used in business are increasingly integrating AI into their tools, further acclimating your employees to these technologies. Examples include LinkedIn, GitHub with GitHub Copilot, and Microsoft's Office 365, all of which incorporate AI in various capacities within their applications.

Using these AIs can indeed save valuable time for your employees on repetitive or creative tasks. However, this dream comes with a darker side.

## Why is "Shadow GPT" a Threat?

Shadow GPT poses a threat similar to the use of any hardware, application, service, or software without approval from the IT department or management. In addition to the inherent risks of Shadow IT, Shadow GPT introduces other types of threats:

### Loss of Control Over Data Provided to the AI

Suppose one of your developers wants to seek assistance from ChatGPT to review or enhance their code, potentially saving them a significant amount of time. However, when they provide the code to the AI for review, it uses this input to train itself. In fact, all data provided to such tools, especially in their free versions, is used to improve them. This means that a third party, which cannot be considered a trusted entity, holds sensitive data belonging to your company.

For this reason, many companies such as Amazon, Samsung, and Accenture have chosen to completely ban generative AIs from the professional environment. They possess vast amounts of proprietary data that serve as a significant competitive advantage, making it unfeasible to grant access to third parties. Furthermore, these tools are not immune to cyberattacks, which could expose your company's data.

### Obtaining Inaccurate Information (Potentially Harming the Company's Reputation)

Generative AIs aim to provide quick access to information to save you time. However, there are instances where the AI may not have a precise answer to your question. Unfortunately, most current generative AI tools tend to provide an answer at any cost, even if it means offering inaccurate information.

The acquisition of "biased or non-objective information" and the risk of "disseminating inaccurate information" are concerns for 51% of respondents in the GetApp study regarding the use of ChatGPT at work.

This can be particularly problematic for a company, especially if the information provided by the AI is intended for external sharing. The company's reputation could be at stake.

For example, the American law firm "Levidow & Oberman" was fined $5,000 after submitting a legal document that cited false cases, all of which were fabricated by ChatGPT.

Generative AI is a powerful tool, but it remains an aid and not an end in itself. Always remember to verify the sources of information and not blindly trust the AI.

### Non-Ownership of AI-Generated Responses/Documents

Another issue is that you will not own the responses or documents provided by the AI. In most cases, the AI retains ownership of the information it transmits to you. This poses a real challenge for companies, as they cannot freely use this information as they wish. To address this (subject to technical and human capabilities), you can deploy your own generative AIs internally, allowing you to retain intellectual property rights over the content generated.

## Restricting Shadow GPT and Ensuring Safe Use

A piece of advice: start regulating the use of generative AI in your company now to raise awareness of these risks among your employees and limit them. While there isn't yet comprehensive state-level regulation for these tools in case of disputes, a firm grasp of AI in the workplace can significantly boost each employee's productivity.

The idea, much like with Shadow IT, isn't necessarily to ban these tools outright but rather to engage in a dialogue with all employees to understand their needs and expectations in this field. Afterward, you can decide which tools to permit and secure their use.
...
Don't delay regulating Shadow GPT in your company to avoid unnecessary risks!

# Qu'est-ce que le shadow IT et quels en sont les risques ?

[Cybersécurité](https://blog.lockself.com/topic/cybers%C3%A9curit%C3%A9) • Temps de lecture 10 min • 07 avril 2023

[](https://twitter.com/intent/tweet/?text=Qu%27est-ce+que+le+shadow+IT+et+quels+en+sont+les+risques+%3F&url=https%3A%2F%2Fblog.lockself.com%2Fdefinition-risques-shadow-it) [](https://www.linkedin.com/sharing/share-offsite/?url=https%3A%2F%2Fblog.lockself.com%2Fdefinition-risques-shadow-it)
...
À noter que ces dernières années, [le télétravail a généralisé la pratique du shadow IT.](https://blog.lockself.com/limpact-du-teletravail-sur-les-donnees-des-entreprises) Les salariés sont souvent confrontés à des problèmes de communication et de partage de fichiers avec leurs collègues lorsqu'ils travaillent à distance. Dans la majorité des cas, ils sont inconscients des risques qui y sont liés. Ils l’exercent donc, sans se rendre compte du danger que leurs actes représentent. 
...
_Utiliser des supports personnels pour accéder aux données de l’entreprise est une forme de shadow IT_
...
_Les principales causes des incidents de sécurité selon le rapport CESIN 2023_
...
À noter que notre solution LockTransfer qui est [certifiée par l’ANSSI](https://www.lockself.com/solutions/LockTransfer-transfert-fichier-securise) permet de réduire considérablement la surface d’attaque de votre entreprise. Munie d’une interface intuitive, notre plateforme mise tout sur l’efficacité et la simplicité d’utilisation. Notre suite s’intègre facilement dans vos outils à l’aide de plug-in notamment pour Office365 & Outlook. Avec elle, deux ou trois clics suffisent à sécuriser vos fichiers sensibles et leur envoi auprès de collaborateurs ou de prestataires externes.  
