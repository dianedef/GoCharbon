...
**Écosystème le plus complet du marché** — 16+ solutions développées : caisse, borne de commande, commande en ligne (white-label sans commission), commande à table (QR code), caisse mobile, écran cuisine (KDS), écran client (ODS), programme de fidélité, frigo connecté, backoffice analytics. Tout est synchronisé nativement.

**100% SaaS, mises à jour gratuites** — Pas de serveur à installer ni à maintenir. Les mises à jour sont automatiques, gratuites et continues. Tu bénéficies toujours de la dernière version sans surcoût.

**50% des effectifs en R&D** — 45 ingénieurs sur 90 employés travaillent sur le produit. 20M€ investis en R&D depuis 2014. L'innovation est le moteur d'Innovorder, pas juste un argument marketing.

**Commande en ligne sans commission** — Contrairement aux plateformes tierces (Deliveroo, Uber Eats) qui prennent 15-30% de commission, la commande en ligne Innovorder est white-label et sans commission. Tu gardes ta marge.
...
- Dark kitchens et food courts
- Restauration collective : cantines d'entreprise, scolaires, santé, EHPAD
...
- **Menu digital synchronisé** — Mis à jour en temps réel depuis la caisse
...
- **Reconnaissance visuelle** — Identification automatique des plats sur le plateau
- **Division par 3** du temps d'encaissement
- **Temps de passage < 3 secondes**
...
- **Rentabilité par plat** — Analyse fine de la marge
...
|------|------|-----------------|--------|
| **Starter** | 79€/mois | 1 | 1 caisse NF525, digitalisation simple |
| **Growth** | 299€/mois | 2 à 10 | Borne, commande en ligne, fidélité, KDS, ODS |
| **Grands Comptes** | Sur-mesure | 10+ | Offre personnalisée pour franchises et réseaux |
...
- **Juillet 2019** — **10 millions d'euros** de Série A (Alto Invest, Evolem, FJ Labs + investisseurs historiques Kreaxi, Inocap Gestion, Anaxago, Petit Poucet). Objectif : 50 recrutements, expansion internationale, cap vers 100M€ de CA
- **2021** — Début du positionnement IA. Travail sur la reconnaissance visuelle des plats
- **2023** — Lancement de l'**IA Scan 1ère génération** : premier scan plateau IA en Europe pour la restauration collective
- **2024** — 2 500+ restaurants clients, 17 000+ points de vente. Expansion vers la restauration collective (cantines scolaires, entreprises, EHPAD). Slogan : "Propulsée par l'IA"
- **Juin 2025** — **Trophée de l'Innovation** au salon Restau'Co (catégorie Équipement) pour l'IA Scan. Lancement de l'**IA Scan 2ème génération**

**Siège** : Paris 75016
**Équipe** : 90 employés (50% en R&D, soit ~45 ingénieurs)
**Investissement R&D** : 20M€+ depuis 2014
**Financement total** : 11M€+ levés
**Index égalité professionnelle** : 90/100
**Support** : Équipe basée en France, disponible 6j/7, support niveau 1/2/3 en interne, techniciens sur site si nécessaire
...
- 2 500+ restaurants et 17 000+ points de vente — adoption massive
- 50% des effectifs en R&D (20M€ investis) — innovation constante
- 100% SaaS, mises à jour gratuites et continues
- Commande en ligne sans commission (contrairement à Deliveroo/Uber Eats)
- Double positionnement : restauration commerciale ET collective
- 30+ intégrations partenaires (Uber Eats, Deliveroo, Stripe, Edenred)
...
- Pas de mode hors ligne documenté (100% cloud/SaaS)
- Moins de caisses installées que Cashpad (2 500 restaurants vs 11 000 caisses)
- Pas encore d'expansion internationale significative (principalement France)
- Dépendance au financement externe (11M€ levés, modèle en croissance)
