...
**Expertise française de 20+ ans** — Lyra Network existe depuis 2001. Ce n'est pas une startup qui pourrait disparaître — c'est un acteur industriel du paiement avec 400+ employés et 100M€ de CA. La stabilité et la pérennité sont garanties.

**PCI-DSS Niveau 1** — La certification la plus élevée en matière de sécurité des paiements. Les données de carte de tes clients sont protégées selon les standards les plus stricts de l'industrie. Lyra gère ses propres data centers en France.

**Page de paiement personnalisable** — La page de paiement (checkout) est entièrement personnalisable : couleurs, logo, champs, moyens de paiement affichés. Elle est responsive (mobile + desktop) et optimisée pour la conversion. Tu peux l'intégrer en iframe, en pop-in ou en redirection.
...
- Collectivités et services publics (paiement de factures en ligne — Lyra est référencé)
- SaaS qui facturent des abonnements récurrents
...
3. **Configuration** — Choisis tes moyens de paiement, personnalise ta page de checkout, configure les règles anti-fraude
4. **Test** — Environnement de test (sandbox) fourni pour valider l'intégration
...
- **Virement bancaire** — Instantané (Open Banking) ou classique
- **Paiement fractionné** — 2x, 3x, 4x sans frais (en partenariat avec Alma, Oney)
...
- **Tokenisation** — Les données de carte sont tokenisées (jamais stockées en clair)
...
- **Commission par transaction** — Pourcentage + fixe (négocié selon le volume et le secteur)
- **Pas de frais d'installation** sur les offres standard
- **Contrat** — Durée et conditions négociées avec Lyra
- **Contact commercial** pour un devis personnalisé

Pour les petits volumes, Lyra propose aussi **Lyra Collect** (offre simplifiée avec tarification plus transparente, à partir de ~1,2% + 0,25€ par transaction).
...
- **ERP** : SAP, Odoo, Cegid
- **Marketplaces** : Module split payment natif
- **Wallets** : Apple Pay, Google Pay, Samsung Pay, PayPal
- **BNPL** : Alma, Oney (paiement fractionné)
...
- **2010-2015** — Lancement de **PayZen**, la marque e-commerce de Lyra. PayZen propose une passerelle de paiement en ligne complète pour les e-commerçants. Expansion internationale : Amérique latine (Brésil, Argentine, Colombie), Inde, Afrique
- **2015-2020** — Lyra atteint **400+ employés** et **~100M€ de CA**. Le groupe est certifié PCI-DSS Niveau 1. Lancement de **Lyra Collect** (solution simplifiée pour les TPE/PME). Ouverture de bureaux au Brésil, en Inde et en Algérie
- **2020-2023** — Intégration des wallets (Apple Pay, Google Pay), du paiement fractionné (partenariats Alma, Oney), et de l'Open Banking. PayZen supporte désormais 250+ moyens de paiement dans 120+ pays. Lyra renforce son positionnement "souveraineté" face aux géants US (Stripe, Adyen)
- **2024-2026** — Lyra continue d'investir dans l'API et les intégrations. Le groupe reste indépendant (pas de levée de fonds, bootstrappé/autofinancé) et profitable. PayZen est la passerelle de paiement française de référence pour les entreprises qui veulent une alternative souveraine à Stripe
...
**La collectivité qui dématérialise les paiements** — Tu gères les paiements d'une mairie (cantine, périscolaire, amendes). PayZen est référencé pour les collectivités avec un niveau de sécurité PCI-DSS Niveau 1. Les administrés payent en ligne, les fonds sont tracés dans le back-office.
...
- PCI-DSS Niveau 1 — sécurité maximale
- 400+ employés, ~100M€ de CA — acteur industriel stable
- 20+ ans d'expertise paiement (depuis 2001)
- Data centers en France
- Plugins CMS (PrestaShop, WooCommerce, Magento, Shopify)
...
- **Notoriété limitée hors France** — Lyra est bien connu en France et en Amérique latine mais moins visible à l'international que Stripe, Adyen ou Mollie. Pour une startup qui vise le marché mondial, PayZen est moins "instagrammable"
- **Interface back-office datée** — Le back-office de gestion des transactions est fonctionnel mais l'UX/UI est moins moderne que les dashboards de Stripe ou Mollie. Pour les équipes qui passent du temps dans le back-office, c'est un point de friction
- **Processus commercial traditionnel** — L'onboarding passe par un commercial, un contrat, et une mise en production. C'est plus lent que l'inscription self-service chez Stripe (paiement en 15 minutes). Pas adapté aux développeurs qui veulent tester vite
- **Pas de marché secondaire des développeurs** — La communauté de développeurs autour de PayZen est plus petite que celle de Stripe. Moins de tutoriels, moins de Stack Overflow, moins de packages open-source
