...
tags:
  ...
  - 'E-commerce'
  - Outils
description: "Yavin est la startup française de terminaux de paiement Android pour commerçants. TPE nouvelle génération, sans engagement. Fondée en 2019. Paris."
pubDate: "2026-03-15"
imgUrl: ../../../../assets/astro.jpeg
u_site: https://yavin.com/
u_origine: "FR"
u_langue_fr: true
...
**Commissions compétitives** — Yavin revendique des taux de commission parmi les plus bas du marché pour les commerçants à volume. Les tarifs sont négociés en fonction du volume de transactions — plus tu encaisses, moins tu payes. Contrairement aux TPE bancaires avec des frais cachés (location, maintenance, engagement), Yavin est transparent.

**Sans engagement** — Pas de contrat de 36 mois comme chez les banques. Tu peux arrêter quand tu veux. Le terminal t'appartient (achat) ou est en location courte durée. Contrat de maintenance inclus.

**Indépendant de ta banque** — Le TPE Yavin fonctionne avec n'importe quel contrat monétique bancaire (Banque Populaire, Crédit Agricole, BNP, SG, etc.). Tu n'as pas besoin de changer de banque pour utiliser Yavin — tu gardes ton contrat VAD et tu branches le terminal Yavin dessus.

**Triplez les pourboires** — L'application Pourboires intégrée au terminal sollicite le client à chaque encaissement avec des suggestions de montant. Résultat : les pourboires sont multipliés par 3 en moyenne selon Yavin. Un vrai argument pour les restaurateurs.
...
- Commerçants avec un volume conséquent (économies sur les commissions)
- Boulangeries, salons de beauté (terminal compact Mini X)
- Événementiel (terminal mobile 4G, mode offline)
...
3. **Choix du terminal** — Sélectionne le terminal adapté à ton activité (Mini X, Yavin X, PinPad, XL, SoftPOS)
4. **Installation** — Réception du terminal, configuration avec ton contrat bancaire existant
...
- **PinPad Yavin** — Terminal fixe Ethernet, côté client et commerçant. Pour les comptoirs
- **PinPad Pro** — Terminal fixe avec intégration caisse (connexion au logiciel de caisse)
...
- **Lien de paiement** — Envoi de liens de paiement par SMS ou email
- **Mode offline** — Encaissement sans connexion internet
...
- **Terminal** — Achat ou location (selon la formule choisie)
- **Commission par transaction** — Taux négocié selon le volume mensuel d'encaissement
- **Abonnement mensuel** — Inclut la maintenance et les mises à jour
- **Sans engagement** — Pas de durée minimum de contrat
- **1 mois offert** — Offre promotionnelle régulière

Les tarifs sont compétitifs pour les commerçants à volume (plusieurs milliers d'euros/mois de CA par carte). Pour les très petits volumes, SumUp ou Square peuvent être moins chers en entrée de gamme.
...
- **TripAdvisor / LaFourchette** : Avis intégrés
- **Contrats bancaires** : Compatible avec tous les contrats monétiques (BP, CA, BNP, SG, CM, etc.)
...
- **2021-2022** — Évolution vers la gamme **Yavin X**. Lancement des applications intégrées (pourboires, avis Google, liens de paiement). Yavin se différencie par l'écosystème d'apps sur le terminal, pas juste par le hardware
- **2023-2024** — Ajout du **SoftPOS** (application qui transforme un smartphone Android en terminal de paiement). Lancement du **Yavin XL** pour la restauration rapide. Yavin est recommandé par **Pennylane** et **independant.io** comme l'un des meilleurs TPE du marché
- **2025-2026** — Yavin continue de croître dans un marché concurrentiel (SumUp, Square, Smile & Pay, myPOS). Le positionnement : pas le moins cher en entrée de gamme (c'est SumUp), mais le meilleur rapport qualité/prix/fonctionnalités pour les commerçants avec du volume. La suite d'applications (pourboires, avis) est un vrai différenciant
...
**La boulangerie qui veut se libérer de sa banque** — Tu payes 45€/mois de location de TPE + des commissions opaques à ta banque depuis 5 ans. Avec Yavin Mini X, tu achètes le terminal une fois, tu gardes ton contrat bancaire, et tu payes des commissions compétitives. Économie : 200-300€/an minimum.
...
- Commissions compétitives pour les commerçants à volume
- Indépendant de la banque — compatible avec tous les contrats monétiques
- Gamme complète : compact, mobile, fixe, écran large, SoftPOS
- Mode offline — encaissement sans internet
...
- **Contrats American Express et Conecs séparés** — Pour accepter Amex ou les titres-restaurant, tu dois souscrire des contrats séparés directement avec ces organismes. Yavin ne s'en charge pas
- **Pas de reviews sur les grandes plateformes** — Peu d'avis sur Trustpilot ou Google. Le produit est encore jeune par rapport aux SumUp et Square de ce monde
- **Dépendance au contrat bancaire** — Tu gardes ta banque, ce qui est un avantage, mais ça veut dire aussi que tu dois avoir un contrat monétique actif. Pour un auto-entrepreneur qui démarre, c'est une étape supplémentaire par rapport à SumUp (qui fournit tout)
