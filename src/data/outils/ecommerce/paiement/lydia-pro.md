...
**Terminal de paiement mobile** — Encaisse par carte bancaire (CB, Visa, Mastercard, sans contact) avec un terminal compact connecté à ton smartphone. Pas de contrat long terme — tu achètes le terminal et tu payes une commission par transaction.

**Liens et QR codes de paiement** — Génère un lien ou un QR code pour encaisser un paiement. Le client paye directement depuis son téléphone — pas besoin de terminal physique. Idéal pour les artisans en déplacement, les marchés, les livreurs.

**Compte pro avec IBAN français** — Un vrai compte professionnel avec IBAN français, carte Visa Business, virements SEPA, et outils de gestion de base. Tout dans la même application que ton compte perso si tu veux.
...
- Micro-entrepreneurs qui veulent un compte pro + encaissement dans une seule app
- Restaurateurs et food trucks qui veulent réduire les files d'attente
...
3. **Compte pro** — Ton compte professionnel avec IBAN français est créé
4. **Terminal** — Commande le terminal de paiement si tu veux encaisser par carte (TPE compact Bluetooth)
...
- **Lien de paiement** — Envoi par SMS, email ou messagerie
...
- **Virements SEPA** — Émission et réception
...
- **Investissement** — Accès à des placements (actions, crypto)
...
| Élément | Prix |
|---------|------|
| **Terminal de paiement** | ~29-79€ (achat unique, selon modèle) |
| **Commission par transaction** | ~1,5-1,75% (varie selon le volume) |
...
| Formule | Prix/mois |
|---------|-----------|
| **Essentiel** | 0€ (fonctionnalités de base) |
| **Pro** | Sur devis (fonctionnalités avancées) |

- **Pas de frais cachés** — Pas d'abonnement obligatoire pour l'encaissement (commission uniquement)
- **Terminal en achat** — Pas de location, le terminal t'appartient
- Les tarifs exacts évoluent régulièrement — vérifier sur le site Sumeria
...
- **Sans contact (NFC)** : Paiement par tap
- **Export** : Historique des transactions exportable
...
- **2018-2019** — **Série B de 40M€** avec **Tencent** (géant chinois, propriétaire de WeChat Pay) et **Accel**. Lydia se lance dans les services financiers : épargne, cashback, paiement en magasin. L'ambition : devenir la super-app financière européenne
- **2020-2021** — Lancement de l'offre pro (TPE, QR code, compte pro). **Série C de 72M€** (2020) puis **86M€** (2021). 5 millions d'utilisateurs. Lydia est valorisée à **1 milliard d'euros** (statut de licorne française)
- **2022-2023** — Obtention de l'**agrément d'établissement de crédit** (ACPR). Lydia passe de "fintech" à "vraie banque". Lancement des produits bancaires : compte courant, carte Visa, crédit, investissement. 7 millions d'utilisateurs
- **Septembre 2024** — **Rebranding en Sumeria**. L'app Lydia devient Sumeria pour marquer la transformation : ce n'est plus juste une app de paiement entre amis, c'est une banque complète. **8 millions d'utilisateurs**. Le nom Lydia reste connu du grand public mais l'app et le site migrent vers Sumeria
- **2025-2026** — Sumeria continue de développer son offre bancaire et pro. **200+ employés** entre Paris et Bordeaux. Le défi : monétiser sa base d'utilisateurs massive (beaucoup utilisent l'app gratuitement pour le P2P) et faire adopter les services payants (pro, banque, crédit)
...
**La prof de yoga indépendante** — Tu donnes des cours à domicile à 50€ la séance. Après le cours, tu envoies un lien de paiement par SMS — ta cliente paye en 3 clics depuis son téléphone. L'argent arrive instantanément sur ton compte pro Sumeria.
...
- Agrément d'établissement de crédit ACPR (vraie banque, garantie FGDR)
- Terminal de paiement compact et abordable
- QR code et liens de paiement sans terminal
- Compte pro avec IBAN français
- +200M€ levés (Tencent, Accel, BPI, CNP Assurances)
- Rebranding Sumeria = ambition bancaire claire
...
- **Commissions élevées** — ~1,5-1,75% par transaction est correct pour un terminal mobile mais plus cher que SumUp (1,25%) ou les contrats bancaires négociés (0,3-0,7%)
- **Pas d'intégrations comptables** — Pas de connexion avec Pennylane, Indy, ou les logiciels de comptabilité. Pour un pro qui veut automatiser sa compta, c'est un frein
- **Monétisation en question** — Lydia/Sumeria a 8M d'utilisateurs mais la majorité utilise l'app gratuitement (P2P). La conversion vers les offres payantes (pro, banque premium) est le défi majeur de l'entreprise
- **Support client critiqué** — Des avis en ligne mentionnent des temps de réponse longs et des blocages de compte difficiles à résoudre. Pour un usage pro (où chaque jour de blocage = perte de CA), c'est un risque
- **Marché très concurrentiel** — Face à SumUp, Zettle, Yavin, Square, et les TPE bancaires traditionnels, l'offre pro Sumeria doit encore prouver sa différenciation
