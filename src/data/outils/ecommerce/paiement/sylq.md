...
**230 000+ terminaux déployés** — Sylq hérite de l'infrastructure Synalcom : 230K terminaux en service chez 20K+ commerçants. Ce n'est pas un MVP — c'est une plateforme qui gère déjà un parc massif de terminaux et une chaîne logistique complète (vente, personnalisation, déploiement, maintenance, support).

**Cryptomonnaies en magasin** — Grâce à la technologie Qori, Sylq permet aux commerçants d'accepter les paiements en cryptomonnaies directement sur le terminal ou via l'app mobile. Le commerçant reçoit des euros — la conversion est automatique. C'est un vrai différenciant pour les early adopters crypto.

**Open Banking (virement instantané)** — Au lieu de payer par carte, le client peut payer par virement bancaire instantané via Open Banking. Les frais sont inférieurs à ceux de la carte bancaire et le paiement est irréversible (pas de chargeback). Un avantage pour les commerçants qui veulent réduire les commissions.
...
- Enseignes et franchises avec un déploiement multi-sites de terminaux
- Commerçants qui veulent accepter les cryptomonnaies
...
3. **Solution** — Choix du terminal (physique), de l'app (SoftPOS) ou de la solution en ligne
4. **Déploiement** — Sylq livre, personnalise et installe les terminaux
5. **Formation** — Prise en main de la plateforme et du dashboard
...
- **Sans contact** — NFC, Apple Pay, Google Pay
...
- **Terminaux** — Achat ou location (prix selon le modèle et le volume)
- **Commission par transaction** — Taux négocié selon le volume et le mix de paiement
- **Abonnement plateforme** — Selon les fonctionnalités activées
- **Support et maintenance** — Inclus dans l'offre
...
- **E-commerce** : Solutions de paiement en ligne
- **Open Banking** : Virement instantané (DSP2)
...
- **2021** — Création de **Qori** par **Alain Falys** et **Daniel Maurice-Vallerey**, deux multi-entrepreneurs fintech (cofondateurs de **Yoyo Wallet** à Londres, anciens de **Visa** et **Mastercard**). Qori développe une plateforme de paiement mobile innovante : carte, Open Banking et cryptomonnaies sur n'importe quel terminal ou smartphone
- **Mars 2023** — **Fusion à 50/50** de Synalcom et Qori pour créer **Sylq**. L'objectif : combiner l'expertise industrielle de Synalcom (parc de 230K terminaux, logistique, support) avec l'innovation technologique de Qori (Open Banking, crypto, SoftPOS). Tony Delalande devient Président de Sylq
- **2023-2024** — Lancement de la plateforme unifiée. Expansion en **Espagne** et **Suisse**. L'équipe atteint **~50 employés**. Sylq se positionne comme la première plateforme de paiement tout-en-un européenne
- **2025-2026** — Sylq continue de croître (+10% d'effectifs par an). La plateforme intègre carte, sans contact, Open Banking, crypto et paiement en ligne dans un seul écosystème. L'ambition paneuropéenne se concrétise avec des clients dans 3 pays
...
**Le commerçant crypto-friendly** — Tu tiens un magasin de tech et tes clients demandent le paiement en Bitcoin. Avec Sylq, tu actives l'option crypto sur ton terminal existant. Le client paye en BTC, tu reçois des euros. Pas de risque de change, pas de wallet crypto à gérer.
...
- 20 000+ commerces déjà équipés (héritage Synalcom)
- 230 000+ terminaux déployés — infrastructure prouvée
- Équipe fondatrice expérimentée (ex-Visa, Mastercard, Yoyo Wallet)
- Présence européenne (France, Espagne, Suisse)
- SoftPOS — smartphone comme terminal
...
- **Crypto encore niche** — L'acceptation des cryptomonnaies est un différenciant mais la demande réelle des consommateurs français est encore très faible (<1% des paiements). Le feature est plus marketing que business-critical aujourd'hui
- **Pas de reviews publiques** — Zéro avis sur Trustpilot, G2 ou Capterra. Difficile d'évaluer la satisfaction client
- **Site web peu détaillé** — Le site sylq.io est minimaliste, avec peu d'informations sur les prix, les fonctionnalités détaillées ou les témoignages. Pour un commerçant qui compare, c'est un manque de transparence
- **Concurrence féroce** — Le marché du TPE/paiement est ultra-compétitif en France (SumUp, Square, Yavin, Smile & Pay, TPE bancaires). Sylq doit prouver sa valeur ajoutée par rapport aux acteurs établis
