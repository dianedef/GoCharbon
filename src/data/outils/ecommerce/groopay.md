...
- **Zéro logistique à gérer** — Tu crées ta commande, tu partages le lien, et Groopay gère le reste : paiements sécurisés, facturation automatique, suivi en temps réel. Plus besoin de courir après les remboursements, de faire des tableaux Excel pour savoir qui a payé quoi, ou de centraliser les commandes à la main.

- **Un outil de cohésion pour ton groupe** — Que tu sois responsable CSE, président d'association ou délégué de classe, la commande groupée devient un levier pour fédérer ta communauté. Tu offres un avantage concret (des prix cassés) tout en renforçant le sentiment d'appartenance au groupe.

- **Dashboard et statistiques en temps réel** — Tu suis l'avancement de chaque commande groupée en direct : nombre de participants, palier atteint, montant total, statut des paiements. Pas de zone d'ombre, tu pilotes tout depuis un tableau de bord clair et intuitif.

- **Made in France et partenaires locaux** — Plateforme française qui met en avant des commerçants et marques françaises. Plus de 80 partenaires référencés dans des catégories variées, de l'artisan chocolatier au producteur de vin en passant par les marques de cosmétiques naturels.
...
- **Collectivités locales** souhaitant proposer des achats groupés aux administrés
- **Écoles et établissements scolaires** pour les fournitures, les sorties, ou les goodies
- **Groupes d'amis ou de voisins** organisant des commandes collectives (paniers bio, vin, épicerie fine)
...
- **Lien de partage** — Un lien unique à diffuser sur tous tes canaux (email, réseaux sociaux, messageries). Chaque participant commande et paie directement via le lien.
- **Dashboard de gestion** — Tableau de bord centralisé pour suivre toutes tes campagnes : nombre de participants, palier atteint, montant collecté, statut de la commande.
- **Statistiques en temps réel** — Suivi live du nombre de participants, du montant total de la commande, et de la progression vers le palier suivant.
- **Paiement sécurisé automatisé** — Les participants paient en ligne de manière sécurisée. Plus besoin de collecter les chèques ou de faire des virements manuels.
...
- **Ventes en volume** — Tu vends par lots, ce qui te permet d'optimiser ta logistique et de réduire tes coûts unitaires.
...
- **Vin & Boissons** — Vins, spiritueux, boissons artisanales
- **Beauté** — Cosmétiques, soins, produits de beauté naturels
- **Bien-être** — Compléments alimentaires, aromathérapie, relaxation
- **Mode** — Vêtements, accessoires, maroquinerie
...
- **Modèle** : B2B — la plateforme connecte des groupes structurés (CSE, associations, collectivités, écoles) avec des commerçants et marques partenaires.
- **Chiffres clés** : plus de **100 000 participants**, **2 500+ commandes**, **80+ partenaires** commerciaux référencés.
- **Secteur** (selon MyFrenchStartup) : Services aux entreprises > Productivité > App mobile, Plateforme web.
...
- **Association de parents d'élèves** : L'APE organise une commande groupée de chocolats artisanaux pour financer la kermesse. 80 familles participent, le palier -25% est atteint, et l'association réalise une marge confortable sur la revente.

- **Club sportif** : Le trésorier du club de rugby lance une commande groupée de vêtements de sport personnalisés. 60 joueurs + supporters commandent, le prix unitaire tombe de 45€ à 28€.

- **Collectivité locale** : La mairie propose aux habitants une commande groupée de produits locaux (vin, huile d'olive, miel) en partenariat avec des producteurs de la région. 500 foyers participent, tout le monde y gagne.

- **Commerçant artisan chocolatier** : Un chocolatier bordelais référence ses coffrets sur Groopay. En 3 mois, il reçoit 15 commandes groupées de CSE qu'il n'aurait jamais touchés autrement. Volume additionnel sans coût d'acquisition marketing.
...
- **Jusqu'à 45% de réduction** — Des économies significatives, surtout sur des catégories comme l'alimentaire et le vin où les marges permettent de vraies baisses de prix
- **100 000+ participants** — La traction est là, c'est une preuve de concept validée par le marché
- **Inscription gratuite** — Pas de barrière à l'entrée, ni pour les organisateurs ni pour les participants
- **Paiement et facturation automatisés** — Plus besoin de jouer les comptables bénévoles pour ton CSE ou ton asso
...
- **Dépendance au volume** — Si tu es dans un petit groupe (moins de 10 personnes), les paliers de réduction intéressants sont difficiles à atteindre. L'outil est surtout pertinent pour des groupes de 20+ participants
- **Concurrence indirecte forte** — Les groupements d'achat informels (Facebook, WhatsApp) sont gratuits et ne nécessitent pas de plateforme. Il faut convaincre les organisateurs de migrer vers un outil dédié
- **Pas d'application mobile dédiée** — Plateforme web uniquement pour le moment, ce qui peut freiner l'adoption dans certains contextes (partage rapide, notifications push)
- **Manque de transparence sur les commissions** — Le modèle économique exact (quel pourcentage Groopay prend sur chaque transaction) n'est pas clairement affiché, ce qui peut créer de la méfiance
- **Notoriété encore faible** — Startup jeune, pas de levée de fonds médiatisée, peu de couverture presse. Tu devras probablement expliquer le concept à ton groupe avant de lancer ta première commande
