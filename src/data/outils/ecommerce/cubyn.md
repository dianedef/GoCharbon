...
**Gestion simplifiée de la logistique** — Grâce à une plateforme conviviale, tu connectais facilement ta boutique en ligne ou tes annonces marketplace. Cubyn se chargeait de l'expédition dès qu'une commande était passée, et tu pouvais suivre en temps réel l'état de chaque livraison, pilotant ainsi tes inventaires et tes livraisons multicanales en toute simplicité.

**Tarifs compétitifs "tout compris"** — Les tarifs de Cubyn incluaient le transport, la gestion des stocks et la préparation des commandes. Tu bénéficiais d'une solution globale à un prix avantageux, t'aidant à maintenir tes marges tout en offrant une expérience de livraison exceptionnelle.
...
3. **Préparation automatique** — Dès qu'une commande arrivait, Cubyn la préparait et l'expédiait
...
- **Suivi en temps réel** de l'état de chaque livraison
...
- **Transport** : coût d'expédition selon le poids et la destination
- **Stockage** : facturation au m³ par mois
- **Préparation** : coût par commande (picking + packing + étiquetage)
- **Frais de démarrage** : intégration offerte
...
- **2016-2018** : premières levées de fonds, développement de la plateforme et des entrepôts
- **2019** : Série B — Cubyn rejoint le programme **French Tech 120** (les 120 startups les plus prometteuses de France)
- **Investisseurs** : **Bpifrance**, **Eurazeo**, **360 Capital Partners**, **DNX Ventures**
- **Total levé** : plus de **50 millions d'euros** sur plusieurs tours de financement
- **Au pic d'activité** : des centaines de marchands e-commerce, plusieurs entrepôts en France, un volume d'avis Trustpilot massif (**11 033 avis**, 4.0/5)
- **2023** : difficultés financières, recherche de rentabilité dans un marché très concurrentiel
...
- **Le fulfillment est un métier à faibles marges** — les coûts opérationnels (entrepôts, personnel, transport) sont élevés et les marges dépendent du volume
- **La concurrence avec Amazon FBA** est brutale — Amazon offre un service similaire avec une échelle incomparable
...
- Tarification "tout compris" transparente
- 4.0/5 sur Trustpilot avec 11 033 avis — volume massif témoignant de l'activité
- Programme French Tech 120 — reconnaissance institutionnelle
...
- Dépendance à un seul prestataire logistique — risque de disruption (confirmé par la liquidation)
- Marges opérationnelles trop faibles face à Amazon FBA et aux acteurs logistiques traditionnels
- Support client parfois critiqué dans les avis Trustpilot négatifs
...
- **Bigblue** — startup française de fulfillment, alternative directe la plus proche
- **HappyColis** — logistique externalisée avec entrepôts en France et au Canada
- **Amazon FBA** — le leader mondial du fulfillment (mais tu perds l'indépendance)
- **Sendcloud** — plateforme d'expédition multi-transporteurs (pas de stockage)
- **Coliback** — solution française spécialisée dans les retours e-commerce
