...
**100% cloud, zéro serveur** — Pas de serveur local à installer, maintenir ou sauvegarder. Clictill tourne dans le cloud (data en France). Tu accèdes à tes données depuis n'importe où : ta caisse, ton bureau, ton téléphone. Les mises à jour sont automatiques et transparentes.

**Certifié NF525** — Conforme à la loi anti-fraude TVA française. L'inaltérabilité, la sécurisation, la conservation et l'archivage des données de vente sont garantis par la certification. Tu es en règle dès le premier jour.
...
- Boutiques de mode, de beauté, de sport
- Espaces retail dans les aéroports, gares, centres commerciaux
...
3. **Déploiement** — Installation sur les postes de caisse (PC, tablette, terminal dédié)
4. **Formation** — Formation des équipes (incluse dans l'offre)
...
- **Modes de paiement** — Espèces, CB, chèque, titres-restaurant, multi-paiement
...
- **Réassort automatique** — Alertes et commandes automatiques
...
| **Business** | 62€ |
| **Premium** | 83€ |
| **Offre découverte** | 59€ (formule d'entrée) |

- **Engagement** — Selon la formule choisie
- **Formation incluse** — Dans les forfaits supérieurs
- **Support inclus** — Assistance technique
- **Tarifs dégressifs** — Pour les déploiements multi-caisses et multi-magasins
...
- **2010-2018** — Lancement de **Clictill**, la version 100% cloud. Migration vers le SaaS. Acquisition de clients de référence : **Bleu Libellule** (réseau de 300 magasins de coiffure), **La Poste**, **Pierre Fabre**
- **2018-2022** — Expansion internationale : **15 pays**. Partenariats avec **Puma** et l'**Aéroport de Lyon**. L'équipe atteint **20-49 employés**. Certification **NF525**. Clictill se positionne comme l'alternative française à Lightspeed et Cegid pour les chaînes de taille moyenne
- **2023-2026** — **300+ clients** actifs. Note **4.9/5 sur Google**. Clictill continue de croître dans le segment des enseignes multi-magasins. L'entreprise est dirigée par **Didier Voyenne** et Jean-Luc Roset. Le positionnement reste clair : caisse cloud pour les chaînes, pas pour les indépendants
...
**La boutique dans un aéroport** — Tu as un espace retail à l'Aéroport de Lyon. Clictill gère la multi-devise (les touristes payent dans leur monnaie), le ticket dématérialisé (les voyageurs ne veulent pas de papier) et le reporting en temps réel (tu suis ton CA depuis ton téléphone pendant que tu es au bureau).
...
- 100% cloud — zéro serveur local, accès depuis partout
- Certifié NF525 — conforme loi anti-fraude TVA
- Multi-magasins / multi-caisses natif — conçu pour les chaînes
- 4.9/5 sur Google
- 20+ ans d'expérience (JLR Distribution depuis 2002)
...
- **Interface moins "sexy" que les apps modernes** — Clictill est fonctionnel mais l'interface n'a pas le côté design/minimaliste d'une app comme Tactill ou Square. C'est un outil enterprise, pas un outil design
- **Pas de version iPad native** — Clictill est cloud/navigateur. Il n'y a pas d'app native iPad ou smartphone — c'est un choix technique (tout passe par le navigateur) qui peut être un frein pour certains usages mobiles
- **Marque peu connue** — Clictill n'a pas la notoriété de Lightspeed ou Cegid. En dehors de son segment (chaînes de taille moyenne), l'outil est peu connu
