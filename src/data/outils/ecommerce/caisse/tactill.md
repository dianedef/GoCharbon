...
**iPad = design + fiabilité** — L'iPad est un objet de qualité que les clients connaissent. Ton comptoir a de l'allure. Et l'écosystème Apple garantit des mises à jour régulières, pas de virus, et une fluidité constante.

**Notes exceptionnelles** — 4.9/5 sur Google, 5/5 sur l'App Store. C'est l'une des apps de caisse les mieux notées du marché français. Les utilisateurs saluent la simplicité, la fiabilité et la réactivité du support.
...
- Organisateurs d'événements et salons (caisse éphémère)
- Boutiques éphémères (pop-up stores)
...
3. **Catalogue** — Ajoute tes produits (nom, prix, catégorie, photo)
4. **Matériel** — Connecte une imprimante de tickets et/ou un tiroir-caisse (optionnel) ou commande la Tactill Box
...
- **Ticket de caisse** — Impression ou envoi par email (ticket dématérialisé)
- **Remises** — Réductions en % ou en montant, bons de réduction
...
|---------|-----------|--------|
| **Essentiel** | 39€ | Caisse, vente, gestion produits, reporting de base |
| **Avancé** | 59€ | + gestion des stocks, multi-employés, statistiques avancées |
| **Premium** | 79€ | + fidélité, connexion e-commerce, fonctionnalités avancées |

- **Tactill Box** — 999€ (kit complet : iPad + imprimante + tiroir-caisse + support)
- **Engagement** — Mensuel ou annuel (réduction sur l'annuel)
- **Essai gratuit** — Période d'essai disponible
...
- **Scanners** : Lecteurs de codes-barres Bluetooth
- **E-commerce** : Synchronisation avec les boutiques en ligne (forfait Premium)
...
- **2016-2019** — Croissance organique. Clients de référence : **Amazon** (boutiques éphémères en France), **Festival de Cannes**, **Futuroscope**, **Fermob**. Tactill reste bootstrappée — pas de levée de fonds, croissance autofinancée
- **2020-2023** — Lancement de la **Tactill Box** (kit complet). Ajout de la fidélité, de la gestion des stocks avancée et de la connexion e-commerce. L'équipe reste petite (estimée à 3-15 employés selon les sources)
- **2024-2026** — Tactill maintient ses notes exceptionnelles (4.9/5 Google, 5/5 App Store). L'app continue d'évoluer avec les mises à jour iPadOS. Le positionnement reste inchangé : la caisse la plus simple pour les indépendants
...
**Le food truck en festival** — Tu fais des festivals l'été. Tu as besoin d'une caisse qui tient dans un sac à dos et qui marche sans Wi-Fi. L'iPad avec Tactill fonctionne en mode hors-ligne. Tu encaisses tout le week-end et les données se synchronisent quand tu retrouves une connexion.
...
- Clients prestigieux : Amazon, Festival de Cannes, Futuroscope
- Tactill Box à 999€ — kit complet prêt à l'emploi
- Interface iPad fluide et design
- Mode hors-ligne (fonctionne sans internet)
- Bootstrappée — croissance saine, pas de dépendance VC
...
- **Pas de TPE intégré** — Tactill est une caisse, pas un terminal de paiement. Pour l'encaissement par CB, tu as besoin d'un TPE séparé (SumUp, Zettle, TPE bancaire). C'est un coût et une complexité supplémentaires
- **Fonctionnalités limitées pour les chaînes** — Tactill est conçue pour les indépendants. La gestion multi-magasins, la centralisation des données et les fonctionnalités de franchise sont limitées par rapport à Lightspeed ou Clictill
- **Pas de version web** — L'application fonctionne uniquement sur iPad/iPhone. Pas d'accès au back-office depuis un navigateur web (à vérifier)
- **Bootstrappée = développement plus lent** — Sans levée de fonds, le rythme de développement de nouvelles fonctionnalités est plus lent que chez les concurrents financés
