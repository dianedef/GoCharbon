...
**Conforme loi AGEC** — Depuis avril 2023, les commerçants ne peuvent plus imprimer de ticket systématiquement. Noticia fournit l'alternative légale : le ticket dématérialisé. Tu es en conformité sans changer ton logiciel de caisse — Noticia s'intègre en surcouche.

**Canal marketing intégré** — Le QR code du ticket n'est pas juste un reçu. C'est aussi un canal marketing : tu peux ajouter des promotions, des demandes d'avis Google, des inscriptions newsletter. Chaque ticket devient un point de contact avec ton client.
...
- Enseignes qui veulent un canal marketing via le ticket
...
3. **Configuration** — Personnalise le design de ton e-ticket et les outils marketing
...
- **Zéro données personnelles** — Le ticket s'affiche sans collecte
...
- **Abonnement par point de vente** — Sur devis
...
- **Avril 2023** — **La loi AGEC entre en vigueur** : fin du ticket de caisse papier systématique. Noticia se retrouve en position idéale — chaque commerçant cherche une solution de dématérialisation
- **2023-2024** — Croissance accélérée : **500+ magasins** déployés. Couverture **France 3**. L'équipe atteint **~10 employés**. Ajout des outils marketing (promotions, avis, newsletter)
- **2025-2026** — Noticia continue de croître avec la généralisation de la dématérialisation des tickets. La concurrence se structure (KillBills, Billiv, Check) mais Noticia a l'avantage du timing et de l'approche zéro friction
...
- 500+ magasins déployés
- Outils marketing intégrés (promos, avis Google, newsletter)
- Fondée à Marseille — solution française
...
- **Pricing opaque** — Pas de tarification publique
- **Pas de reviews publiques** — Aucun avis sur les plateformes
- **Dépendance à la loi AGEC** — Si la loi évolue ou si les logiciels de caisse intègrent nativement la dématérialisation (ce qui arrive), Noticia perd son avantage
- **Concurrence croissante** — KillBills, Billiv, Check proposent des solutions similaires. Le marché du ticket dématérialisé se structure rapidement
