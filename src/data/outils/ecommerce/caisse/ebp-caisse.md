...
**275 000 utilisateurs** — EBP est le logiciel de gestion le plus installé chez les TPE françaises. Ton expert-comptable connaît EBP, ton formateur connaît EBP, ton technicien connaît EBP. L'écosystème de support est massif.

**40 ans d'existence** — Fondé en 1984, EBP a survécu à toutes les révolutions technologiques (DOS, Windows, Cloud, SaaS). Quand tu choisis EBP, tu choisis la pérennité. Et le rachat par Cegid (2024) renforce encore cette garantie.

**Conforme loi anti-fraude TVA** — Le module Point de Vente est certifié conforme aux obligations légales françaises. Pas de mauvaise surprise lors d'un contrôle fiscal.
...
- TPE qui utilisent déjà EBP pour la compta ou la gestion
...
3. **Configuration** — Paramètre ton catalogue produits, tes modes de paiement, tes employés
4. **Matériel** — Connecte imprimante de tickets, tiroir-caisse, scanner (compatibles standard)
...
- **Retours et avoirs** — Gestion des retours produits et émission d'avoirs
- **Remises** — En pourcentage ou en montant, globales ou par ligne
...
| Formule | Prix |
|---------|------|
| **SaaS** | À partir de 36€/mois |
| **Licence** | À partir de 569€ (achat définitif) |
| **Pack Point de Vente complet** | Sur devis (caisse + gestion + compta) |

- **SaaS** — Abonnement mensuel avec mises à jour incluses
- **Licence** — Achat unique + maintenance annuelle optionnelle
- **Packs** — Réduction si tu prends plusieurs modules EBP (compta + paie + caisse)
- **Formation** — En option (ou incluse dans certains packs)
...
- **EBP Paie** : Écosystème de gestion RH intégré
- **EBP CRM** : Gestion de la relation client
...
- **2000-2015** — Passage sous Windows, puis premières offres en ligne. EBP atteint **200 000+ utilisateurs**. L'écosystème est complet : compta, paie, gestion, CRM, point de vente
- **2015-2023** — Transition vers le **SaaS/Cloud**. EBP propose ses logiciels en abonnement mensuel en plus des licences. **275 000 utilisateurs**, **650-740 employés**, CA **~65M€** (2023)
- **Juillet 2024** — **Rachat par Cegid**, le plus grand éditeur français de logiciels de gestion (1,2 Md€ de CA). EBP devient **"EBP, A Cegid Company"**. L'objectif : combiner la force de frappe de Cegid (grands comptes) avec la base installée d'EBP (TPE/PME)
- **2025-2026** — EBP prépare la **réforme de la facturation électronique 2026**. Le rachat par Cegid garantit la pérennité et les investissements en R&D. Le module Point de Vente continue d'être maintenu et amélioré
...
**La boutique qui prépare la facturation électronique** — La réforme 2026 arrive. Avec EBP, tu as un éditeur qui prépare activement la transition. Tes factures de caisse seront automatiquement conformes au nouveau format — pas besoin de changer d'outil.
...
- Rachat par Cegid (2024) — garantie d'investissement
- Écosystème complet : compta + paie + gestion + CRM + caisse
- Conforme loi anti-fraude TVA
- Prêt pour la facturation électronique 2026
- 650-740 employés — support et développement à grande échelle
...
- **Pas une caisse "pure"** — EBP Point de Vente est un module dans un écosystème de gestion. Si tu veux juste une caisse simple sans compta/paie/gestion, c'est overkill
- **Transition Cegid incertaine** — Le rachat par Cegid est récent (2024). À moyen terme, la stratégie produit pourrait évoluer : fusion avec Cegid Retail ? Arrêt du module séparé ? L'incertitude existe
- **Pas mobile** — Le module Point de Vente est conçu pour PC/poste fixe. Pas d'app mobile pour les food trucks, marchés ou événements. Pour la mobilité, il faut un autre outil
- **Tarification pas ultra-compétitive** — À 36€/mois en SaaS ou 569€ en licence (sans les modules complémentaires), EBP est dans la moyenne haute. Si tu n'as pas besoin de l'écosystème EBP, des solutions comme Tactill (39€) ou mybe (39€) sont plus simples et moins chères
