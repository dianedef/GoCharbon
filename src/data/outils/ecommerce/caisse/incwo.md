...
**Module caisse certifié NF525** — Facile TILL, le module caisse d'Incwo, est certifié NF 525 (conforme loi anti-fraude TVA). C'est rare dans un ERP — la plupart des concurrents (Axonaut, Sellsy) n'ont pas de module caisse intégré. Tu gères ta boutique et ton back-office avec le même outil.

**140 000+ utilisateurs, 17 ans d'existence** — Incwo existe depuis 2007. En 17 ans, 140 000 personnes ont utilisé l'outil. C'est un track record de longévité rare dans le SaaS français, surtout sans levée de fonds.

**À partir de 9€ HT/mois** — Le plan Start à 9€ est accessible pour les micro-entrepreneurs. Et même le plan le plus complet (499€/mois) est moins cher qu'un ERP Sage ou SAP.
...
- Freelances et consultants qui veulent facturation + CRM + gestion de projets
- Artisans qui gèrent devis, factures, stocks et caisse
...
3. **Configuration** — Active les modules nécessaires (facturation, CRM, stocks, caisse, RH, projets)
4. **Import** — Importe tes données existantes (clients, produits, fournisseurs)
...
|------|-------------|-------|
| **Start** | 9€ | Micro-entrepreneurs, démarrage |
| **Pro** | 29€ | Indépendants, petites équipes |
| **Business** | 49€ | PME, fonctionnalités avancées |
| **Premium** | 79€ | Multi-utilisateurs, modules complets |
| **Expert** | 149€ | Groupes, multi-sites |
| **Entreprise** | 249€ | ETI, personnalisation |
| **Illimité** | 499€ | Tout inclus, sans limites |

- **Pas de version gratuite** (mais essai disponible)
- **Extensions** — Certaines extensions peuvent avoir un coût additionnel
...
- **Caisse** : Module Facile TILL NF525
...
- **2015-2020** — Rebranding en **Incwo**. Ajout du module caisse **Facile TILL** (certifié NF 525). Lancement des 100+ extensions modulaires. L'approche : "un ERP que tu construis toi-même avec les briques dont tu as besoin"
- **2020-2023** — **140 000+ utilisateurs** cumulés, **~5 000 clients actifs**. Certification **NF 203** pour la facturation. Intégration bancaire avec **Qonto**. L'équipe reste à **~12 employés** — croissance maîtrisée
- **2024-2026** — Préparation de la **facturation électronique obligatoire 2026**. Notes : **4.6/5 Google**, **4.8/5 Facebook**. Incwo reste 100% bootstrappé — 17 ans sans levée de fonds, preuve d'un modèle économique sain. Guillaume Besse : *"Nous avons mis tout notre argent dans notre produit."*
...
**Le consultant freelance** — Tu fais du conseil et tu vends aussi des formations. Incwo gère tes propositions commerciales (pipeline CRM), tes factures (facturation conforme), ton suivi de temps (par projet), et même ta boutique en ligne (vente de formations). À 29€/mois, c'est moins cher qu'un Sellsy.
...
- 140 000+ utilisateurs, 17 ans d'existence
- 100% bootstrappé — modèle économique sain
- Certifié NF 203 & NF 525 — prêt facturation électronique 2026
- À partir de 9€ HT/mois — accessible
- 100+ extensions modulaires
...
- **Pas de version gratuite** — Pas de freemium. Pour tester, il faut s'inscrire à un essai
- **3.67/5 sur LeBonLogiciel** (18 avis) — Les notes sont bonnes sur Google et Facebook mais plus mitigées sur les plateformes spécialisées
- **Jack of all trades** — Tout faire, c'est le risque de ne rien faire parfaitement. La caisse Incwo est moins riche qu'une caisse spécialisée (Tactill), le CRM est moins avancé qu'un CRM dédié (Pipedrive), et la facturation est moins poussée qu'un outil spécialisé (Pennylane)
- **Notoriété limitée** — Face à Axonaut, Sellsy et Pennylane qui investissent massivement en marketing, Incwo reste discret. Beaucoup d'entrepreneurs ne connaissent pas l'outil
