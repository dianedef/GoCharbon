...
**10 000 salons** — Kiute était le leader français du logiciel de salon. Quand 10 000 salons utilisent le même outil, c'est que le produit répond aux besoins métier spécifiques (planning par coiffeur, durée variable selon le soin, tarification différenciée, fidélité).

**Réservation en ligne 24/7** — Tes clients réservent directement en ligne, à toute heure. L'agenda se met à jour en temps réel. Pas besoin de répondre au téléphone pour prendre des RDV — tu te concentres sur tes clients en salon.
...
3. **Réservation** — Active la réservation en ligne. Les clients réservent depuis ton site, Google ou l'app Booksy
4. **Agenda** — Gère les plannings de chaque collaborateur. Rappels automatiques par SMS
...
- **Rappels SMS** — Automatiques avant le RDV (réduit les no-shows)
...
| **Par collaborateur supplémentaire** | +10€ HT/mois |

- Le prix exact dépend du nombre de collaborateurs et des fonctionnalités activées
- Migration vers Booksy Biz en cours — les tarifs peuvent évoluer
...
- **2020** — **Fusion avec LeCiseau** (autre logiciel de salon français). L'entité fusionnée devient **Kiute**. Le parc installé atteint **10 000 salons**, **250 000 réservations/mois**, **120M€ de volume d'affaires additionnel/an**
- **Fin 2021** — **Rachat par Booksy** (startup polonaise, leader mondial de la réservation beauté avec 30M+ utilisateurs dans 6 pays). Kiute Pro devient la brique française de Booksy. L'objectif : créer le leader européen du logiciel de salon
- **2022-2024** — Migration progressive des clients Kiute Pro vers **Booksy Biz**. Période de transition avec des problèmes techniques rapportés par les utilisateurs (bugs, lenteur, fonctionnalités manquantes)
- **Fin 2025** — **Migration achevée**. Les comptes non migrés passent en **lecture seule** au 31/12/2025. La marque Kiute Pro disparaît progressivement au profit de Booksy. **Trustpilot : 1.2/5** (223 avis) — les problèmes de migration ont impacté la satisfaction
- **2026** — Booksy Biz est désormais le produit. Kiute Pro n'est plus le logiciel de référence — c'est Booksy qui prend le relais. Les fonctionnalités spécifiques au marché français sont maintenues (caisse, conformité TVA)
...
- 250 000 réservations/mois — volume prouvé
- 8,5M€ levés pré-acquisition
- Rachat par Booksy — accès à un écosystème international (30M+ utilisateurs)
...
- **Perte de l'identité française** — Booksy est polonais. Les décisions produit se prennent à Varsovie, pas à Paris. Les besoins spécifiques du marché français (conformité TVA, culture salon) risquent de passer au second plan
- **Comptes non migrés en lecture seule** — Depuis le 31/12/2025, les salons qui n'ont pas migré vers Booksy Biz ne peuvent plus utiliser leur compte Kiute Pro. C'est une migration forcée
- **Tarification en hausse possible** — Le passage à Booksy peut s'accompagner de nouveaux tarifs internationaux, potentiellement plus élevés que les tarifs Kiute Pro historiques
- **Support en transition** — Le support technique est en transition entre les équipes Kiute (France) et Booksy (international). Les temps de réponse peuvent être plus longs
