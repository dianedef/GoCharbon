...
- **Stancer** (français, startup récente, commission basse)
- **myPOS** (bulgare, TPE avec compte marchand intégré)
- **Yavin** (français, orienté restauration et commerce de proximité)
...
**Compatible avec ton compte bancaire actuel** — Contrairement à SumUp qui pousse son propre compte, Smile&Pay fonctionne avec n'importe quel compte professionnel existant. Tu gardes ta banque, tu gardes tes habitudes.

**Encaissement partout, tout le temps** — Grâce à la carte SIM intégrée dans les modèles autonomes (Smart, Maxi, Super Smile), tu encaisses en terrasse, sur un marché, en salon professionnel, chez le client. Pas besoin de WiFi, pas besoin de connecter un smartphone.

**Livraison express en 48h** — Tu commandes, tu reçois ton TPE en 2 jours, tu branches et tu encaisses. L'activation est instantanée.

**Multi-canal** — Au-delà du TPE physique, Smile&Pay propose aussi le **paiement à distance** (lien de paiement par SMS ou email) et un **module de paiement en ligne**. Tu couvres tous tes canaux de vente avec un seul prestataire.
...
- **Indépendants et freelances** (coachs, consultants, thérapeutes) qui veulent proposer le paiement par carte à leurs clients
- **Associations et comités d'entreprise** qui organisent des ventes ponctuelles
...
3. **Commande en ligne** — Paiement par CB sur le site smileandpay.com.
4. **Réception en 48h** — Le terminal arrive prêt à l'emploi.
5. **Activation** — Branche le terminal, connecte-le à ton compte pro via l'app Smile&Pay.
...
- **Paiements acceptés** : carte contact, sans contact (NFC), Apple Pay, Google Pay
- **Batterie** : autonomie pour une journée d'encaissement
...
- **Imprimante** : intégrée pour les tickets de caisse
- **Paiements** : carte contact, sans contact, NFC, Apple Pay, Google Pay, titres-restaurant
...
- **Écran** : grand écran tactile couleur
- **Imprimante** : intégrée
...
- **Double écran** : un côté commerçant, un côté client
- **Connexion** : WiFi + carte SIM 4G intégrée
- **Imprimante** : intégrée
- **Applications** : accès au Play Store pour installer des apps métier (caisse, gestion stock, fidélité)
...
- **Titres-restaurant** : Edenred, Sodexo, Swile, Up
...
- **Rapports de vente** (journaliers, hebdomadaires, mensuels)
...
|---|---|---|---|---|
| **Prix du terminal** | 39 EUR HT | ~149 EUR HT | ~229 EUR HT | 289-299 EUR HT |
| **Commission** | 1,55% | 1,55% | 1,55% | 1,55% |
| **Abonnement** | 0 EUR | 0 EUR | 0 EUR | 0 EUR |
| **Engagement** | Aucun | Aucun | Aucun | Aucun |
...
- **Commission** : 0,49% + frais d'interchange (IC) + 0,05 EUR par transaction
- L'interchange varie selon le type de carte (débit, crédit, entreprise, étrangère)
...
|---|---|---|---|
| Commission | 1,55% | 1,75% | 1,75% |
| Prix terminal | Dès 39 EUR HT | Dès 39 EUR | Dès 29 EUR |
...
- **Banques** : compatible avec **tout compte bancaire professionnel** français
...
- **2019-2020** : Extension de la gamme avec les modèles Smart Smile et Maxi Smile. Ajout du paiement sans contact et NFC.
- **2021-2022** : Lancement du Super Smile (Android complet avec double écran). Ajout du paiement à distance par lien SMS/email.
- **2023-2024** : Développement des services additionnels : QR code paiement, fonctionnalités de caisse, gestion des pourboires. Intégration des titres-restaurant dématérialisés.
...
> "Excellente solution pour les petites entreprises comme la mienne. Pas besoin d'abonnement mensuel, et la carte SIM intégrée est un vrai plus pour accepter les paiements n'importe où. Un must pour les commerçants itinérants !" — **Tito69, commerçant itinérant**
...
**Coach sportif à domicile** : Tu te déplaces chez tes clients. Plutôt que d'encaisser des chèques ou des virements, tu sors ton Mini Smile, tu connectes ton smartphone, et le client tape sa carte. 39 EUR d'investissement initial et c'est réglé.

**Restaurant avec 15 000 EUR de CA mensuel** : Tu passes sur l'offre Plus à 0,49% + IC + 0,05 EUR. Sur 15 000 EUR, tu paies environ 150 EUR de commissions au lieu de 232 EUR avec l'offre Essentiel. Le Super Smile avec double écran permet au client de choisir son pourboire.
...
- Aucun engagement ni abonnement obligatoire avec l'offre Essentiel
- Compatible avec n'importe quel compte bancaire professionnel
- Carte SIM 4G intégrée sur les modèles autonomes (pas besoin de WiFi)
- Livraison en 48 heures, activation instantanée
...
- La tarification "Plus" avec interchange variable peut être difficile à anticiper
- Seuil minimum de 350 EUR/mois d'encaissement pour éviter les frais d'inactivité
...
- [Avis sur MoneyRadar](https://moneyradar.org/banque/smile-et-pay/)
- [Test complet sur Mobile Transaction](https://fr.mobiletransaction.org/smile-pay-france/)
- [Avis sur Independant.io](https://independant.io/avis/smile-and-pay/)
