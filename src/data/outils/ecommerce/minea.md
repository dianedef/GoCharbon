...
**Produits gagnants** — L'outil identifie les produits qui génèrent le plus d'engagement publicitaire. Si un produit a des milliers de likes et commentaires sur ses ads, c'est un signal fort qu'il se vend bien.

**Espionnage de boutiques** — Tu peux analyser les boutiques de tes concurrents : quels produits ils vendent, quelles publicités ils lancent, quel est leur positionnement prix.

**Recherche de fournisseurs** — Minea identifie les fournisseurs des produits (AliExpress, CJ Dropshipping, etc.). Tu trouves le produit gagnant ET le fournisseur en même temps.
...
- Entrepreneurs qui veulent lancer une boutique de niche
...
3. **Filtres** — Filtre par type de produit, date, nombre de likes, commentaires
4. **Analyse** — Étudie les publicités gagnantes (créatives, textes, engagement)
...
- **Pinterest Ads** — Analyse des épingles sponsorisées
- **Instagram Ads** — Publicités Instagram et placements influenceurs
...
|------|-----------|---------|
| **Starter** | 49€ | 1 plateforme (Facebook), 10 000 résultats/recherche |
| **Premium** | 99€ | Multi-plateforme (FB + TikTok + Pinterest), filtres avancés |
| **Business** | 299€ | Toutes plateformes, Shop Spy, influenceurs, API |

- **Essai gratuit** disponible
- **Réduction annuelle** — Économie significative sur l'engagement annuel
...
- **Croissance rapide** — +200 000 utilisateurs revendiqués. ~66 employés. CA estimé ~6,5 millions de dollars. Minea s'est imposé comme la référence francophone de l'ad spy, face à AdSpy (US, 149$/mois)
- L'outil a rapidement élargi sa couverture de Facebook seul à TikTok, Pinterest et Instagram — reflétant la diversification des canaux publicitaires e-commerce
...
- Recherche de produits gagnants avec données d'engagement
- Identification des fournisseurs (AliExpress, CJ)
- Analyse de boutiques concurrentes
...
- **Éthique** — L'espionnage publicitaire soulève des questions d'éthique. Tu copies les produits et les stratégies des autres — c'est légal mais discutable
- **Marché saturé** — Les produits "gagnants" identifiés par Minea sont vus par des milliers d'utilisateurs. La concurrence est immédiate
- **Dropshipping controversé** — Le dropshipping en général est de plus en plus critiqué (délais de livraison longs, qualité variable, SAV difficile)
