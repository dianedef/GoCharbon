...
**Centralise tes commandes et tes stocks** — Dès qu'une commande est passée sur n'importe quelle marketplace, Iziflux la centralise automatiquement dans le back-office de ton CMS. La synchronisation des stocks en temps réel avec les différentes places de marché évite les ruptures de produits et les erreurs de commande. Tu gères tout depuis un seul endroit.

**Optimise tes prix avec le repricing automatique** — Le module de veille des prix surveille les tarifs pratiqués par tes concurrents (tarifs les plus bas et les plus hauts constatés sur le marché) et ajuste automatiquement tes offres. Tu peux indiquer un prix plancher pour maintenir un tarif de vente minimal et protéger tes marges.

**Suis ta rentabilité en détail** — Tu peux suivre facilement l'ensemble de tes ventes ainsi que la rentabilité de chaque campagne avec des statistiques détaillées : chiffre d'affaires et marge, ROI, coût d'acquisition. Tu définis tes propres indicateurs de performance et tu exportes les résultats en Excel. L'envoi automatique de rapports par mail est paramétrable.
...
- **Agences e-commerce** qui gèrent les flux produits de plusieurs clients
- **Vendeurs Amazon/Cdiscount/Fnac** qui veulent étendre leur présence sur d'autres marketplaces
...
3. **Importe ton catalogue** — Ton catalogue produit est importé et catégorisé automatiquement pour chaque marketplace
4. **Configure tes canaux de vente** — Sélectionne les marketplaces et comparateurs sur lesquels tu veux diffuser (Amazon, eBay, Fnac, Cdiscount, Google Shopping, BackMarket…)
5. **Définis tes règles** — Configure les règles de référencement (quels produits sur quels canaux), les prix, les stocks à diffuser
...
- **Règles de référencement** — publie ou dépublie tes produits selon la rentabilité, la saisonnalité, le stock, les opérations marketing
- **Optimisation SEO** des fiches produits pour chaque place de marché
...
- **Indicateurs personnalisables** — définis tes propres KPIs de performance
...
| Plan | Prix/mois (HT) | Références | Fonctionnalités |
|------|----------------|------------|-----------------|
| **Starter** | 49€ | Jusqu'à 100 | Toutes les fonctionnalités : marketplaces et comparateurs illimités, tracking, gestion commandes/stocks, statistiques |
| **Business** | 99€ | Jusqu'à 500 | Toutes les fonctionnalités |
| **Enterprise** | 169€ | À partir de 500 | Forfait évolutif selon le nombre de références. Devis personnalisé au-delà de 5 000 références |

Notes :
- **2 mois d'essai gratuit** — teste toutes les fonctionnalités avant de t'engager
- **Sans engagement** — abonnements mensuels, pas de contrat annuel obligatoire
- **Pas de commission** sur les ventes — tu paies un forfait fixe, pas un pourcentage de ton CA
...
- **WooCommerce** — plugin d'intégration
- **Shopify** — connexion directe
...
- **Internationales** : Amazon (tous les pays), eBay (tous les pays)
...
- **8 millions d'attributs produits** gérés sur la plateforme
- **400+ marketplaces et comparateurs** connectés
- **Équipe française** — support et accompagnement en français
...
- **Le retailer avec 5000 références** : tu gères un gros catalogue et tu veux le diffuser sur Google Shopping et les comparateurs de prix. Iziflux catégorise automatiquement tes produits, optimise le SEO de chaque fiche, et tu suis la rentabilité par canal
...
- Repricing automatique intégré — pas besoin d'outil tiers pour la veille concurrentielle
- Synchronisation des stocks et commandes en temps réel — évite les ruptures et erreurs
- Catégorisation automatisée (mapping) — gain de temps sur l'intégration catalogue
- 500 clients actifs et 8 millions d'attributs gérés — preuve de fiabilité à grande échelle
- 2 mois d'essai gratuit — large période de test avant engagement
- Sans engagement et sans commission — forfait fixe mensuel uniquement
- Outils de filtrage et de mapping pour faciliter la catégorisation des produits
...
- Pas de plan gratuit permanent — après les 2 mois d'essai, il faut souscrire un abonnement
- Le plan à 169€/mois peut devenir cher pour les gros catalogues (5000+ références) — devis personnalisé
- Moins de visibilité internationale que Lengow ou ChannelAdvisor
- Peu d'avis publics sur Trustpilot, G2 ou Capterra — difficile d'évaluer la satisfaction à grande échelle
- Le repricing automatique nécessite une configuration fine pour éviter la guerre des prix
- Support de marketplaces principalement européennes — couverture limitée en Asie
