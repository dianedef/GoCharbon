...
tags:
  ...
  - 'E-commerce'
  - Outils
description: "Mirakl est la licorne francaise du SaaS marketplace. Plateforme B2B/B2C pour creer et gerer des marketplaces. 450+ clients (Carrefour, Decathlon, Best Buy). Valorisee 3,5 Mds$. Fondee 2012."
pubDate: "2026-03-28"
imgUrl: ../../../assets/astro.jpeg
u_site: https://www.mirakl.com/
u_origine: "FR"
u_langue_fr: false
...
**Elargir ton catalogue sans stock** -- Le modele marketplace te permet d'ajouter des milliers de produits via des vendeurs tiers sans acheter de stock. Leroy Merlin a ajoute 30 000 produits en quelques mois avec Mirakl. C'est de la croissance de catalogue a risque zero.

**IA pour le catalogue** -- L'IA de Mirakl fait le mapping de catalogue 1000x plus vite qu'un humain : detection des doublons, enrichissement des fiches, categorisation automatique. Quand tu as 100 000 references de 500 vendeurs differents, c'est indispensable.

**Ecosysteme de 100 000+ vendeurs** -- Via Mirakl Connect, tu accedes a un reseau de plus de 100 000 vendeurs pre-qualifies. Tu n'as pas a prospecter un par un. Les vendeurs qui sont deja sur d'autres marketplaces Mirakl peuvent rejoindre la tienne en quelques clics.
...
- Marques qui veulent creer un ecosysteme autour de leurs produits
...
3. **Onboarding vendeurs** -- Recrute tes premiers vendeurs via Mirakl Connect ou en direct. Les outils en libre-service simplifient l'onboarding
...
- **Commandes** -- Workflow complet : commande, expedition, retour, remboursement
...
- **Licence SaaS** -- Abonnement annuel base sur le volume de transactions (GMV) et le nombre de vendeurs
- **Frais d'implementation** -- Projet d'integration initial (plusieurs mois, equipe dediee)
- **Commission** -- Mirakl prend generalement un pourcentage sur le GMV de la marketplace
- **Budget minimum** -- Compte plusieurs dizaines de milliers d'euros par an minimum. C'est un outil pour les entreprises qui font du volume
...
- **PIM** : Akeneo, Salsify, Contentserv
- **Paiement** : Adyen, Stripe, Mangopay, HiPay
...
- **2012** -- Creation de **Mirakl** a Paris. Premiere levee de 2,2 millions d'euros. 15 employes. L'idee : proposer la meilleure plateforme SaaS au monde pour lancer et operer des marketplaces
- **2015** -- Levee de **18 millions d'euros**. Premiers grands clients. Mirakl s'impose comme la reference en France
- **2019** -- Levee de **62 millions d'euros**. Expansion internationale, ouverture du bureau de Boston. Les grands retailers commencent a adopter le modele marketplace massivement
- **2020** -- Levee de **255 millions d'euros**. Integration au **Next40** (les 40 startups francaises les plus prometteuses). Mirakl devient la **10e licorne francaise**. Le Covid accelere l'adoption du e-commerce et du modele marketplace
- **2021** -- Levee de **555 millions de dollars** (Serie E, menee par **Silver Lake**, avec Bain Capital Ventures, 83North, Elaia, Felix Capital, Permira). Valorisation : **3,5 milliards de dollars**. ARR : 100M$+. 600 employes. Mirakl est la plus grosse levee de fonds SaaS en France
- **2023** -- Mirakl atteint la **rentabilite** sur son activite historique (marketplace platform) pour la premiere fois en 13 ans. ARR : 177M$. Les nouveaux produits (Ads, Payout, Connect) sont encore en phase d'investissement
- **2025** -- ARR : **218 millions de dollars** (+23% vs 2024). Profitabilite confirmee. 450+ clients. 100 000+ vendeurs. Best Buy lance sa marketplace sur Mirakl. L'entreprise compte environ **800 employes** entre Paris et Boston
...
- Plateforme complete (marketplace, dropship, ads, paiements, catalogue IA)
- Licorne francaise rentable (218M$ ARR, profitable)
- Mirakl Connect (reseau de 100 000+ vendeurs pre-qualifies)
...
- **Dependance SaaS** -- Une fois ta marketplace construite sur Mirakl, migrer vers une autre solution est un chantier majeur. C'est un choix strategique long terme
- **Interface en anglais** -- Mirakl est une entreprise internationale. La plateforme et la documentation sont principalement en anglais. Le support est disponible en francais, mais l'outil lui-meme n'est pas localise FR first
- **Surqualifie pour les petits projets** -- Si tu veux juste ajouter 50 vendeurs a ta boutique Shopify, Mirakl est surdimensionne. C'est un outil pour les organisations qui veulent en faire un axe strategique
