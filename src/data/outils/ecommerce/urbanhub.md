...
- Tech
- IA
imageNameKey: urbanhub
u_site: https://www.urbanhub.fr
u_affi: null
u_affiAdmin: null
title: Urbanhub
author: Diane
description: 'Découvre Urbanhub : outil français pour entrepreneurs, fonctionnalités
  et avis.'
pubDate: '2024-03-25'
...
- 💼 Les fondateurs, Bernard Ochs et Steve Grandfils, ont une vaste expérience en entrepreneuriat et logistique.
- 💡 Urbanhub est reconnu pour son innovation depuis 2016 et a été retenu par la Région Île de France pour son concept de hub urbain décarboné.
- 🚚 Ils développent des logiciels de yield management en partenariat avec l'Inde, envisageant un dépôt de brevet en 2021.
- 🌐 Leur approche omnicanal et leur ERP les distinguent des concurrents tels que La Poste, Ecolotrans, Cubyn, FM Logistic, Axelis et Logtex.
- 💰 Leur modèle économique repose sur le Saas, basé sur le stockage, les services, et le transport sous-traité. Ils ont connu une croissance significative, avec un budget de 1,3 million d'euros en 2020.
- 📈 Urbanhub a levé 2,5 millions d'euros entre 2015 et 2019 et compte 70 clients actifs.
- 🏆 Ils ont été invités par Accor à Vivatech 2019.
- 📧 Pour suivre l'actualité d'Urbanhub, vous pouvez vous abonner à la newsletter EcommerceMag.fr.


- 🏢 Urbanhub propose une logistique urbaine, durable et technologique.
- 🌐 Ils fournissent un ERP interne pour gérer la supply chain des e-commerçants.
- 📦 Urbanhub personnalise les préparations de commandes, y compris des livraisons habillées aux couleurs des marques.
- 💼 Ils travaillent avec des entreprises de toutes tailles, y compris les petites structures.
- 👥 Le service client est au cœur de leurs préoccupations, et ils sont flexibles pour offrir le meilleur service possible.
- 🌱 Urbanhub s'engage à réduire l'impact environnemental en utilisant des modes de livraison décarbonés.
...
- [Urbanhub - Logistique urbaine à la demande - YouTube](https://www.youtube.com/@urbanhub-logistiqueurbaine8811)
...
- Gestion des tournées de livraison efficiente
- Intégration avec les boutiques en ligne pour une gestion simplifiée.