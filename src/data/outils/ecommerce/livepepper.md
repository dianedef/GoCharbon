...
toolSubcategoryPrimary: commande-en-ligne
toolFacets:
  - restauration
  - click-and-collect
  - livraison
...
sourcesVerification:
  - "https://www.livepepper.fr/mentions-legales/"
  - "https://www.livepepper.fr/tarifs/"
  - "https://www.livepepper.fr/"
notesQualification: "SARL immatriculee au RCS de Grasse (495 233 249), siege a Sophia Antipolis, dirigeant Antoine Monnier. Ancrage economique partiel car presence internationale significative (UK, IT, AU, US) et equipe partiellement distribuee. Hebergement des donnees non documente publiquement, pas de DPO identifie, CGV datant de 2018."
methodologieVersion: "gocharbon-v1"
title: LivePepper
author: Diane
tags:
- Outils
description: LivePepper est la solution française de commande en ligne pour restaurants,
  dark kitchens et chaînes. 0% commission, click & collect, livraison, bornes, app
  mobile. 12M+ commandes. Sophia Antipolis.
pubDate: '2026-03-28'
imgUrl: ../../../assets/astro.jpeg
u_site: https://www.livepepper.fr
---
...
**Tes données clients t'appartiennent** — Quand un client commande sur Deliveroo, c'est Deliveroo qui possède la relation. Sur LivePepper, tu récupères les emails, les historiques de commande, les préférences. Tu peux relancer, fidéliser, faire du marketing direct.

**Ton identité, ton site** — Le site de commande est personnalisable à tes couleurs, avec ton nom de domaine. Tes clients commandent chez toi, pas sur une marketplace générique.

**Multi-sites natif** — Gestion centralisée depuis le siège ou par point de vente. À partir de 2 restaurants jusqu'à des centaines de points de vente. Tarif préférentiel dès le 5ème.
...
- **Personnalisation des produits** — Composition sur mesure, moitié-moitié
- **Commande à l'avance** — Le client choisit son créneau
- **Historique des commandes** — Réachat rapide côté client
...
- **Export données clients** — Pour tes campagnes email/SMS
...
- **Gestion de la disponibilité** — Activation/désactivation des produits en un clic
...
|------|----------------|-------------|------------|--------|
| **Standard** | Click & collect avancé | 59€/mois | Avec ou sans | Site responsive, personnalisation produits, commande à l'avance, coupons/promos, paiement en ligne, support email |
| **Expert** | Click & collect + livraison | Sur demande | Avec ou sans | Standard + livraison, Google Maps, fidélité, parrainage, vente additionnelle, Edenred, multi-sites, export données |
| **Premium** | Click & collect + livraison + app | Sur devis | Avec ou sans | Expert + application mobile native |

- **Frais de mise en place** : à partir de 299€ (design personnalisé, formation backoffice, réservation nom de domaine, page d'accueil à tes couleurs, configuration paiement)
- **0% commission** sur toutes les formules — tu paies uniquement l'abonnement
- **Essai gratuit 30 jours** — Sans carte bancaire, site sur adresse provisoire
...
- **Présence internationale** : France, Royaume-Uni, Italie, Australie, États-Unis
- **12 millions de commandes** traitées sur la plateforme
- **400 millions d'euros** de transactions
- **Support** : 7j/7, du lundi au samedi de 9h à 18h, par email et téléphone
...
- 12M+ commandes et 400M€+ de transactions — plateforme éprouvée à grande échelle
- Intégration Uber Direct — livraison sans commission marketplace
- Multi-sites natif — adapté aux chaînes et franchises dès 2 restaurants
- Essai gratuit 30 jours sans carte bancaire
- Données clients 100% propriétaires — pas de captation par une marketplace
- Support 7j/7 inclus
...
- Pas de certification NF525 (logique, ce n'est pas une caisse)
- Moins de fonctionnalités internes qu'Innovorder (pas de KDS, pas de bornes propriétaires, pas d'IA)
- Application mobile uniquement en formule Premium (sur devis)
- Frais de mise en place minimum 299€ — même pour la formule Standard
