...
**SEO intégré** — WiziShop intègre 50+ optimisations SEO automatiques : URLs propres, balises schema.org, sitemap XML, meta tags optimisables, AMP, Core Web Vitals optimisés. C'est l'argument n°1 de WiziShop face à Shopify.

**IA pour les fiches produit** — L'IA de WiziShop génère automatiquement les descriptions de tes produits, les meta descriptions et les textes marketing. Tu gagnes des heures de rédaction.

**Support français** — Support 100% français par chat, email et téléphone. Les business coaches WiziShop accompagnent les marchands dans leur lancement. Pas de chatbot, des humains.
...
- Artisans et créateurs qui vendent leurs produits
...
3. **Produits** — Ajoute tes produits (manuellement ou via import CSV)
4. **Paiement** — Configure les moyens de paiement (CB, PayPal, etc.)
...
- **Paiement** — CB (Stripe, PayPlug, Payzen), PayPal, virement, chèque
- **Livraison** — Colissimo, Mondial Relay, Chronopost, UPS, DHL
- **Multi-langue** — Boutique multilingue
...
- **Schema.org** — Données structurées produit automatiques
- **Sitemap XML** — Génération automatique
- **Core Web Vitals** — Pages optimisées pour la vitesse
...
- **Promotions** — Codes promo, ventes flash, lots
- **Cross-sell / Upsell** — Recommandations produit
...
|------|-----------|---------|
| **Essentiel** | 27€ | Toutes les fonctionnalités, 0% commission |
| **Avancé** | 77€ | + Business coach, support prioritaire |
| **e-Commerce 360** | Sur devis | Solution sur mesure, accompagnement dédié |

- **Essai gratuit** 15 jours
- **Sans commission** — 0% de commission sur les ventes (contrairement à Shopify qui prend 0,5 à 2%)
...
- **Marketplaces** : Amazon, Google Shopping, Facebook/Instagram Shopping
- **Marketing** : Mailchimp, Google Ads, Facebook Ads, Google Analytics
...
- **2018** — Lancement de **Dropizi**, la solution de dropshipping du groupe WiziShop
- **2020-2022** — Accélération avec le boom e-commerce post-Covid. Intégration de l'IA pour la génération de fiches produit. WiziShop dépasse les 400 fonctionnalités intégrées. Effectif : ~26-28 salariés. CA estimé : ~3M$
- **2023-2024** — WiziShop continue de développer l'IA et le SEO comme différenciateurs face à Shopify
- **Novembre 2025** — **⚠️ WiziShop est placé en redressement judiciaire** (procédure de sauvegarde). L'avenir de la plateforme est incertain. Les marchands sont invités à surveiller la situation et à préparer un plan B
...
- IA pour la rédaction de fiches produit
- 0% commission sur les ventes
- Support 100% français (chat, email, téléphone)
...
- **Dépendance SaaS** — Tes données sont chez WiziShop. Si tu veux migrer, c'est un projet. Avec PrestaShop, tu gardes tout
- **Moins connu à l'international** — WiziShop est focalisé sur le marché francophone. Pour vendre à l'international, Shopify est plus adapté
- **Templates limités** — Le choix de templates est plus restreint que chez Shopify ou Wix
- **⚠️ Redressement judiciaire** — WiziShop est en procédure de sauvegarde depuis novembre 2025. L'avenir de la plateforme est incertain. Risque majeur pour les marchands qui dépendent de WiziShop
