...
**Préserve ta trésorerie avec le paiement à 60 jours** — Tu passes commande aujourd'hui, tu paies dans 60 jours. Cela te laisse le temps de vendre les produits avant de les payer. Pour un petit commerçant indépendant, c'est un levier financier considérable qui évite les tensions de trésorerie et permet de tester de nouvelles marques sans risque financier immédiat.

**Réduit drastiquement tes frais de port** — Ankorstore mutualise les livraisons de toutes les marques commandées. À partir de 300€ d'achats multi-marques, tu bénéficies du franco de port. Comme l'explique Nicolas Pivot : "Le souci qu'on peut avoir à nous, commerçants, ce sont les frais de livraison qui risquent d'être importants. Avec Ankorstore, à partir de 300€, on a un franco de port multimarques."

**Découvre des marques émergentes et artisanales** — La plateforme met en avant des marques indépendantes, artisanales et écoresponsables qui n'ont pas toujours la visibilité des grands catalogues. Pour les marques, c'est un canal de distribution puissant pour "être vu par énormément de commerçants", et pour les détaillants, c'est une source de produits différenciants.
...
- **Épiceries fines et commerces alimentaires** qui veulent référencer des marques artisanales
- **Boutiques de décoration et lifestyle** qui cherchent des marques tendance et différenciantes
- **Marques indépendantes et artisans** qui veulent distribuer leurs produits dans des milliers de boutiques en Europe sans force commerciale terrain
...
3. **Passe commande multi-marques** — Ajoute des produits de plusieurs marques dans ton panier. Le minimum de commande est de 100€ par marque pour la première commande
4. **Profite du franco de port** — À partir de 300€ d'achats combinés multi-marques, les frais de port sont offerts
5. **Paie à 60 jours** — La facture centralisée est réglée à 60 jours par prélèvement. Tu as le temps de vendre avant de payer
...
- **Filtres avancés** : par pays d'origine, gamme de prix, nouveautés, best-sellers, marques écoresponsables
- **Fiches marques détaillées** : histoire de la marque, conditions de vente, photos produits, conditions wholesale
...
- **Paiement centralisé à 60 jours** — une seule facture pour tous les fournisseurs
- **Prélèvement automatique** à échéance — pas de gestion manuelle des paiements
...
- **Analytics** : suivi des ventes, des visites, des taux de conversion
- **Programme Brand Ambassadors** : programme de recommandation entre marques
...
- **Liste de favoris** pour sauvegarder les marques et produits repérés
...
| Élément | Détail |
|---------|--------|
| **Inscription** | Gratuite (détaillant et marque) |
| **Commission marque** | 0% — aucune commission sur les ventes |
| **Minimum de commande** | 100€ par marque (1ère commande) |
| **Franco de port** | Offert à partir de 300€ multi-marques |
| **Paiement détaillant** | À 60 jours, prélèvement automatique |
| **Frais de service** | Frais facturés aux détaillants (inclus dans le prix affiché) |
...
- **Comptabilité** : factures centralisées exportables au format PDF/CSV
...
- **2021** : Série B de 100M€ — expansion européenne (Allemagne, UK, Pays-Bas, Belgique)
- **Janvier 2022** : Série C de 250M€ menée par Tiger Global, valorisation à 1,75 milliard d'euros — **statut de licorne**
- **2022-2023** : expansion à 9 pays européens, 30 000 marques, 300 000+ détaillants
- **2023-2024** : restructuration et recentrage après la correction des valorisations tech — réduction d'effectifs, focus sur la rentabilité
- **Investisseurs** : Tiger Global, Bond Capital, Index Ventures, Bain Capital Ventures, Eurazeo, GFC
- **Siège social** : Paris, France — avec des bureaux à Berlin, Londres, Amsterdam, Barcelone
...
> "Moi, j'ai à peu près 50 fournisseurs. Ce serait terrible si je ne passais pas par la plateforme." — **Nicolas Pivot, Ma Boutique Alternative**
...
- **L'épicerie fine indépendante** : tu cherches des produits artisanaux (confitures, chocolats, thés, spiritueux). Ankorstore te donne accès à des centaines de petits producteurs avec une logistique centralisée
...
- Franco de port multi-marques à partir de 300€ — économies logistiques considérables
- Zéro commission pour les marques — modèle attractif pour les fournisseurs
- Fondée par l'équipe d'A Little Market (racheté par Etsy) — expertise marketplace prouvée
- Facture et paiement centralisés — simplification administrative massive
- 9 pays européens couverts — accès à un catalogue international
...
- **Paiement à 60 jours par prélèvement automatique** — certains commerçants préfèrent choisir leur date de paiement
- **Pas de marketplace B2C** — Ankorstore ne vend pas au grand public, c'est strictement B2B (il faut un SIRET)
- **Frais de service inclus** — le détaillant paie des frais intégrés au prix, ce qui peut rendre certains produits plus chers que l'achat direct auprès de la marque
- **Support client parfois débordé** — avec 300 000+ détaillants, les temps de réponse peuvent être longs
- **Dépendance à la plateforme** — si Ankorstore ferme ou change ses conditions, les commerçants perdent leur canal d'approvisionnement centralisé
- **Peu de visibilité sur les avis publics** — pas de page Trustpilot ou G2 très active pour vérifier la satisfaction utilisateur
