...
**UGC monétisé** — Les photos de tes clients (User Generated Content) deviennent des outils de vente. Tu collectes les photos postées par tes clients sur Instagram, tu les tagues avec tes produits, et tu les affiches sur ton site. La preuve sociale qui vend.

**Galeries sur site** — Intègre des galeries visuelles shoppable sur tes pages produit, ta homepage ou tes landing pages. Ça remplace les carrousels de photos classiques par du contenu vivant et engageant.
...
- Retailers qui veulent intégrer l'UGC sur leur site
...
3. **Tagging** — Tagge les produits sur les images et vidéos
4. **Galeries** — Crée des galeries shoppable
...
- **UGC** — Collecte et modération du contenu généré par les clients
...
- **Lookbook** — Collections visuelles interactives
...
- **Sur devis** — Pour les grandes marques et retailers
...
- **Multiples pivots** — L'entreprise a considérablement évolué au fil du temps :
  - **Phase 1** — Fashion tech / mode (tagging de produits sur photos)
  - **Phase 2** — Micro-influence (plateforme de mise en relation marques-influenceurs)
  - **Phase 3** — Live shopping (expériences d'achat en direct vidéo)
  - **Phase 4** — Vidéo IA pour le e-commerce (génération de vidéos produit par IA)
- **Clients revendiqués** — L'Oréal, Yves Saint Laurent, Clarins, Chanel (grandes marques de luxe et beauté)
- **⚠️ Difficultés financières** — BAO/Reetags est en **procédure collective**. L'avenir de la plateforme est incertain. Les marques clientes sont invitées à prévoir des alternatives
...
- Multi-source (Instagram, TikTok, UGC)
- Galeries intégrables sur tout site e-commerce
...
- **UGC limité** — Si tes clients ne postent pas de contenu, tu n'as pas d'UGC à exploiter
- **Petite notoriété** — Face à Bazaarvoice ou Nosto, Reetags est un acteur de niche
- **ROI variable** — Le social commerce fonctionne mieux pour la mode, la beauté et le lifestyle que pour l'électronique ou l'industriel
- **⚠️ Difficultés financières** — BAO/Reetags est en procédure collective. Risque de cessation de service. Vérifier le statut avant de s'engager
- **Pivots multiples** — L'entreprise a changé de direction 3-4 fois (mode → micro-influence → live shopping → vidéo IA). Le positionnement final n'est pas stabilisé
