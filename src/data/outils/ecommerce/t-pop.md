...
**Éco-responsable** — Textiles en coton bio (certifiés GOTS/OCS), encres à base d'eau (certifiées OEKO-TEX), emballages recyclables. T-Pop compense son bilan carbone. C'est du merch éthique.

**Production en France** — Tout est imprimé et expédié depuis la France. Délais de livraison courts (2-5 jours en France), empreinte carbone réduite, qualité contrôlée.

**Intégration e-commerce** — T-Pop se connecte à Shopify, WooCommerce, Etsy, WiziShop. Les commandes sont synchronisées automatiquement. Tu vends sur ta boutique, T-Pop gère la production et l'envoi.
...
- Marques qui veulent du merch éco-responsable
...
3. **Produits** — Choisis les produits (t-shirts, sweats, mugs, etc.)
4. **Mockups** — Génère les visuels de tes produits
5. **Boutique** — Connecte ta boutique (Shopify, WooCommerce, Etsy)
...
- **Textiles bio** — Coton certifié GOTS (Global Organic Textile Standard)
...
- **International** — Livraison monde entier
...
- **Abonnements optionnels** — Gratuit / 30€/mois (Pro) / 70€/mois (Business) pour des fonctionnalités avancées (branding, priorité, API)
- **Prix produit** — Variable selon le produit (t-shirt bio ~12€, sweat ~25€, mug ~8€)
- **Livraison** — Frais de port à la charge du client (ou intégrés dans ton prix)
- **Pas de minimum** — 1 commande ou 1 000, même prix unitaire
...
- **2022-2024** — Développement de la plateforme et du catalogue produit. T-Pop s'impose dans la communauté francophone du POD. Adoption par les créateurs, influenceurs et petites marques. Effectif : 10-19 salariés
- **2025-2026** — T-Pop élargit son catalogue (accessoires, maison, enfant) et ses intégrations (Etsy, WiziShop). L'accent sur l'éco-responsabilité et le made in France continue de différencier T-Pop face aux géants US
...
- Zéro stock, zéro investissement initial
- Inscription gratuite (pas d'abonnement)
- Intégrations Shopify, WooCommerce, Etsy
...
- **Pas de production hors France** — Si tu vends aux US, le produit est expédié depuis la France. Délais plus longs et frais de port plus élevés que Printful (qui produit aux US)
- **Limité au merch** — T-Pop c'est du textile et accessoires. Pas d'électronique, pas de packaging personnalisé complexe
- **Dépendance** — Tu dépends de T-Pop pour la production et l'expédition. Si T-Pop a un problème, tes clients attendent
