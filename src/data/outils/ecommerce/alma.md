...
**Paiement immédiat garanti** — Tu es payé à J+7, Alma gère 100% du risque : fraude, impayés, recouvrement. Pas de mauvaise surprise. C'est Alma qui porte le risque financier, pas toi.

**Zéro frais de retard pour le consommateur** — Contrairement à Klarna ou Affirm, Alma ne facture aucun frais de retard aux consommateurs. C'est un différenciateur majeur qui renforce la confiance et la satisfaction client.

**Multi-canal : en ligne et en boutique** — Alma fonctionne aussi bien sur ton site e-commerce qu'en point de vente physique. Un seul outil pour tous tes canaux de vente.

**10 pays, une seule solution** — France, Belgique, Allemagne, Italie, Espagne, Pays-Bas, Autriche, Luxembourg, Portugal, Irlande. Tu déploies le paiement fractionné dans toute l'Europe depuis un seul compte.
...
- Retailers multi-canaux (online + offline) dans toute l'Europe
- Toute entreprise B2C avec des achats de 50€ à 4 500€+
...
- **Financement étendu (Alma Financing)** — 6, 8, 10 ou 12 mensualités pour les paniers plus importants
...
- **Magento / Adobe Commerce** — Extension Marketplace
- **Salesforce Commerce Cloud** — Intégration native
...
- **Mars 2020** — **Série A : 12,5M€** (Idinvest Partners, Bpifrance)
- **Janvier 2021** — **Série B : 49M€** (Cathay Innovation, Idinvest, Bpifrance Large Venture, Seaya Ventures, Picus Capital). Lancement du service Pay Later (15/30 jours)
- **Février 2022** — **Série C : 210M€** (115M€ equity + 95M€ dette). Nouveaux investisseurs : **Tencent**, GR Capital, Roosh Ventures. Existants : Cathay Innovation, Eurazeo, Bpifrance, Seaya Ventures, Picus Capital. Valorisation proche du statut "soonicorn" (~1 Md€)
- **2023** — Expansion dans 10 pays européens (ajout Pays-Bas, Autriche, Luxembourg, Portugal, Irlande)
- **2024** — Lancement de l'**app mobile Alma**, partenariat renforcé avec **Checkout.com** (4x de croissance marchands), centre de service client à **Lille**, migration vers participation SEPA directe avec **Mambu** (30% de réduction des coûts)
- **2025** — 21 800+ marchands, 1 Md€+ de transactions annuelles

**Siège** : 176 Avenue Charles de Gaulle, 92200 Neuilly-sur-Seine
**Forme juridique** : SAS (SIREN 839 100 575, RCS Nanterre)
**Équipe** : 200-300+ employés, 27 nationalités
**Bureaux** : France (Neuilly-sur-Seine HQ + 7 espaces + Lille service client), Milan, Bruxelles, Amsterdam
...
- **Etam** — Mode féminine
- **Lancel** — Maroquinerie de luxe
- **Alain Afflelou** — Optique
- **Nature & Découvertes** — Bien-être et nature
- **Le Slip Français** — Mode made in France
- **Maje** — Prêt-à-porter
- **Zadig & Voltaire** — Mode premium
- **Mauboussin** — Joaillerie
- **Promod** — Mode
- **Devred** — Mode masculine
- **Effy** — Rénovation énergétique
...
- Zéro frais de retard pour le consommateur (différenciateur vs Klarna)
- 280M€+ levés (solidité financière, investisseurs de premier plan dont Tencent et Eurazeo)
- +20% de conversion prouvé (cas Maisons du Monde)
- 10 pays européens depuis un seul compte
- Licence ACPR double (établissement de paiement + société de financement)
...
- Concurrence internationale forte (Klarna, PayPal Pay Later) avec des moyens plus importants
- Pas encore profitable publiquement (forte croissance mais modèle encore en phase d'investissement)
- Limité au B2C — pas encore de solution B2B mature
- Réglementation BNPL en évolution en Europe (risque de contraintes supplémentaires)
