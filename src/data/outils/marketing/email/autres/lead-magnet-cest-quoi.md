...
author: Diane
description: 'Découvre Lead Magnet C''Est Quoi : outil français pour entrepreneurs,
...
- best lead magnet idea
    ...
    **Some best examples are,**
    ...
    SEMRush’s 10 searches per day trial, Lenskart’s first frame for free offer, these all are the lead magnet which attracts new customers
    
    Here few ideas of lead magnets that you can use to attract in your affiliate marketing business
    
    **#1. Ebook**
    
    Very basic lead magnet which numbers of bloggers used to attract new leads on regular basis
    
    You can write 5-20 pages problem-solving ebook or even a 1-page checklist and offer that for free in return of email and name
    
    Even this is work for Amazon affiliate blogger as well
    
    Let’s say you have a dog affiliate site then write an ebook on "meal plan for dog" or anything related to dog
    
    This is just an example, I don’t know much about dog so please understand by yourself if I'm wrong
    
    **#2. Webinar**
    
    This is again good if you are looking for some high-quality leads.
    
    Offer a free problem-solving webinar and build your list
    
    **#3. Newsletter**
    
    If you don’t have anything to offer then keep this option
    
    This is not going to help you until you not have any authority in your niche
    
    So, I don’t recommend this to you but you can use it with some lucrative headline. Could be work
    

This free training shows media buyers how to increase their ROAS on retargeting ads by up to 300% by leveraging behavioral science.

# [Side Project Marketing: What Is It & How to Do It (+10 Examples)](https://www.failory.com/blog/side-project-marketing)

In 2021, [**153,047**](https://whaly.io/posts/hacker-news-2021-retrospective) users were active on [**Hacker News**](https://news.ycombinator.com/), a tech community built by Y Combinator.

In only 24 hours, [**35,000**](https://patwalls.com/side-project-marketing-in-36-hours) people visited [**How to Say No**](https://www.starterstory.com/how-to-say-no), Starter Story’s collection of email templates to say “no” in different situations.

In less than 2 weeks, [**106**](https://marketingexamples.com/seo/seo-project-marketing) high-authority websites provided a backlink to Kapwing, featuring [**Cartoonify**](https://www.kapwing.com/cartoonify), their free AI-powered tool that turns photos into cartoon drawings.
...
[**Hatchful**](https://hatchful.shopify.com/), by Shopify, is a free logo maker. eCommerce founders looking for a logo might also be interested in an eCommerce platform and might convert to Shopify’s customers.
...
RamseySolutions has [**a quiz**](https://www.ramseysolutions.com/taxes/tax-preparation#quiz) that tells you what’s the best way for you to file your taxes. Through the results, they promote their tax preparation service.
...
[**How Much to Make an App**](http://howmuchtomakeanapp.com/) is an app development cost calculator made by Z1, a digital product studio. When the calculator provides you the results, you’re suggested to hire them to get your app built.
...
Baremetrics, an analytics tool for Stripe, has an “[**Open Startups**](https://baremetrics.com/open-startups)” page where you can find the numbers of lots of transparent startups showcased within the Baremetrics tool.
...
SparkToro is a market research and audience intelligence tool. As a way to attract digital marketers (their potential customers), they have built “[**Trending**](https://sparktoro.com/trending/)”, a digital marketing resource aggregator.
...
Mention is a media monitoring and social listening tool. In order to showcase how interesting their data is, they created [**Battle of the Brands**](https://battleofthebrands.io/), a game that lets you compare the online mentions of any two brands.
...
ActiveCampaign, an email marketing and CRM tool, provides [**a free CRM**](https://www.activecampaign.com/free-marketing-tools/crm-template) for Excel or Google Sheets. On the same page where you can download the template, they claim that it won’t be enough for specific needs and that you should instead use ActiveCampaign’s CRM.
...
Gusto has an online [**Employee Onboarding Checklist**](https://gusto.com/tools/employee-onboarding-checklist). It’s a perfect fit with their business, as they are an HR, benefits, and payroll tool.
...
4 Benefits of Engineering as Marketing
----------
...
[**Website Grader**](https://website.grader.com/), by Hubspot, is the best example of this. This is a tool where you can enter your website’s URL and they tell you a score and what you can do to improve it.
...
However, nowadays, you can build pretty much every Engineering as Marketing project you can think of with no-code tools. [**Calconic**](https://www.calconic.com/) (for calculators), [**Outgrow**](https://outgrow.co/) (for calculators and quizzes), and [**Bubble**](https://bubble.io/) (for more complex projects) are some of the best no-code tools for building this kind of project.
...
Programmatic SEO consists of programmatically generating hundreds or thousands of pages from a set of data and making them rank on Google for long-tail keywords. I wrote a [**long guide about Programmatic SEO here**](https://www.failory.com/blog/programmatic-seo).
