...
Baptiste Robert est un hackeur white hat de gros calibre, et il a automatisé tout le process OSINT pour le vendre avec son entreprise [Predicta Lab](https://predictalab.fr/).

Donc par exemple si je veux chercher Baptiste Robert il va lancer un automatisme, mettre ce nom dans son moteur et il va te resortir toute sa vie numérique toutes les informations publiques qui sont inscrits et accessible sur les réseaux sociaux, Google et tous les autres sites, en un clic
