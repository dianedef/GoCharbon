...
- ## [React Bricks](https://appsumo.com/products/react-bricks/) Le CMS collaboratif du futur
    ...
    - [https://reactbricks.com/comparisons/react-bricks-vs-webflow](__MASK_20__)
    ...
    - As for the "full-fledged web apps", I think that this space is really very interesting and we'll see a big advance in low-code app création in the coming years. I think React Bricks won't become a tool to create apps, but will stay a tool for content management. We have some other ideas in the "app création" space, but for now we want to keep our efforts focused on React Bricks.
    ...
    - In this way you will see that when you scaffold a project with the CLI you will choose the React framework and you will have a complète project set up for you, ready with static site generation.
