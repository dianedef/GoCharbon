...
Vous en avez assez de la complexité de **Google Analytics** et de son impact sur la vie privée de vos visiteurs ? Alors laissez-moi vous parler de **[Plausible Analytics](https://plausible.io/)**, une alternative open source rafraîchissante qui se concentre sur l’essentiel au travers de son interface épurée et intuitive.
...
Vous pouvez aussi spécifier des événements custom pour suivre les objectifs importants pour votre business, comme les clics sur des boutons d’action ou les pages vues d’un tunnel de conversion. Je vous invite à lire la [documentation](https://plausible.io/docs) qui détaille toutes les possibilités offertes.

A vous de voir maintenant si vous balancez Google Analytics au profit de [Plausible](https://plausible.io/).

[(130) JavaScript côté navigateur : Manipuler les cookies - YouTube](https://www.youtube.com/watch?v=9AdBFTM2lVM)
...
2. Google is not a search engine, it is not simply a maker of productivity tools. Google is a giant advertising platform.
3. Google is spectacularly, awesomely, frighteningly successful as an advertising platform. The gold ingots are coming out at an alarming rate and being used for all kinds of other things.
4. Google’s success, the fact that it is so good at what it does, the fact that it is crapping out a mountain of gold ingots, is terrible for us and society.
...
*[Google Ads Timeline compiled by Search Engine Land](https://searchengineland.com/search-ad-labeling-history-google-bing-254332)*
...
[Avis Hyros : La meilleure solution pour tracker tes publicités ?](https://lesmakers.fr/hyros/)


[[GA4] Passer à Google Analytics 4 - Aide Google Analytics](https://support.google.com/analytics/answer/10759417?utm_campaign=2022-q4-gbl-all-gafree&utm_source=google-growth&utm_medium=email&utm_content=ga4-migration-migrate-conversions)  
[Analytics](https://analytics.google.com/analytics/web/?utm_campaign=2022-q4-gbl-all-gafree&utm_source=google-growth&utm_medium=email&utm_content=ga4-migration-migrate-conversions#/a197655930p273328777/admin/setup-assistant/goals-migration&sa=D&source=docs&ust=1651072987855045&usg=AOvVaw0MFlPbLDC0yQjH4PN3gRSW)
omme mentionné il y a quelques mois, à partir du 1er juillet 2023, Universal Analytics
c
(version 3) ne sera plus disponible. Après avoir servi pendant 15 ans, il touche enfin à sa
fin. Mais ne vous inquiétez pas, lorsque nous disons "à sa fin", nous voulons dire qu'il ne
collectera plus de nouvelles données. Cependant, vous pouvez toujours accéder à vos données
existantes pour faire des comparaisons ou suivre leur évolution dans le temps.
Si vous utilisez Google Analytics, vous devrez passer à la version 4, idéalement avec une version
proxifiée comme le recommande la CNIL (Commission nationale de l'informatique et des libertés),
pour filtrer les données personnelles des utilisateurs. Vous pouvez visiter nos amis de Adding Well.
Nous avons rédigé un article charmant que vous pourrez lire au coin du feu.
Axeptio et Google Analytics 4 ?
Du côté du consentement avec votre widget Axeptio vous n'avez pas besoin de faire des changements
spécifiques. Vous avez un "google_analytics" cookie déclaré dans le back-office Axeptio . Cette adresse
cookie détermine si le déclenchement de votre balise Google Analytics ou le mode de consentement
passe de "refusé" à "accordé". Il est visible dans votre widget de consentement.
Vous trouverez les différentes configurations de déclenchement dans notre documentation.
Il n'est donc pas nécessaire d'apporter des modifications à votre back-office. Le seul changement à
effectuer concerne le système qui déclenche la balise, où vous passerez de la balise Universal à
Analytics 4. Il s'agit d'un processus simple qui ne prend que quelques minutes.
Si vous utilisez un outil comme Google Tag Manager, conservez la même exception dans la section des
déclencheurs.


## Le consentement contextuel
1
maginez un restaurant où, simplement parce que vous regardez la porte d'entrée, le
serveur se précipite vers vous et vous oblige à commander un plat, sur-le-champ.
N'est-ce pas inimaginable ? Pourtant, c'est précisément ce qui se produit lorsque vous utilisez un mur
de consentement conventionnel pour recueillir le consentement decookie.
À peine avez-vous cliqué sur le lien vers le site qu'une fenêtre apparaît brusquement, vous empêchant
d'agir sans avoir été préalablement salué et vous demandant de faire un choix, sous peine de
conséquences. Ce n'est pas une expérience très agréable !
Bien sûr, il peut s'agir d'un outil précieux pour l'interaction, mais il peut aussi contribuer à un taux de
rebond élevé. Facile d'accès, facile de sortie, adieu au visiteur !
Optimisez le consentement et mettez l'accent sur l'expérience
utilisateur
Compte tenu de l'engagement de Axeptioà ne pas compromettre l'expérience utilisateur, la conformité
et le précieux insights obtenu à partir des données (nous sommes également pleinement conscients
des avantages de ces outils O), nous avons créé une version hybride appelée Contextual Consent
Wall (mur de consentement contextuel).
Le principe : le recueil échelonné du consentement
Lorsque l'utilisateur arrive sur votre page, le widget classic Axeptio s'affiche sans interrompre la
navigation dans le contenu de la page. Il reste ainsi dans la meilleure humeur possible, sans blocage ni
frustration, ce qui réduit la probabilité qu'il quitte la page.
Cependant, une fois que vous avez déterminé que l'utilisateur est suffisamment impliqué dans le
contenu du site, vous pouvez afficher un widget de consentement qui bloque le milieu de l'écran.
Vous avez la possibilité de le déclencher quand et comme vous le souhaitez, que ce soit au moment du
clic, après avoir parcouru une certaine distance ou après avoir passé un certain temps sur le site. À vous de choisir