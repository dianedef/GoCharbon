...
🔹✅💡🥊🛡️🔇🧠📣🎁🏆📚🛠💥🙌😱❌✂️
## [Comment j'ai fait 120K$ de MRR avec les outils AppSumo : étude de cas de Taylor Hersom](https://blog.appsumo.com/taylor-hersom-case-study/?utm_source=as-klaviyo&utm_medium=flow-email&utm_campaign=Case_Study_WS%20%28XVN4kH%29&_kx=2PtX9X1bySCTo1zw63LXaupY0-pTmqM73hU4U3QetH-flnhIjOyKYaAqRZMExU67.Ktp4ZG)
- Taylor Hersom, fondateur d'Eden Data, a atteint 120 000 $ de revenus mensuels récurrents (MRR) grâce à une entreprise de conseil en cybersécurité et protection des données.
- Il a découvert AppSumo en recherchant des solutions technologiques de pointe pour son entreprise via le podcast "My First Million".
- AppSumo a permis à Taylor de réaliser des économies sur les logiciels, ce qui lui a permis de réallouer davantage de fonds à ses employés et à de nouvelles initiatives commerciales.
Chez AppSumo, nous sommes là pour donner aux entrepreneurs les moyens d'utiliser des outils numériques qui sont si bons qu'ils te feront tomber à la renverse. Dans cette étude de cas, tu entendras le scoop de l'un de nos clients préférés, devenu un fan à vie.

Nous te donnerons un aperçu exclusif des coulisses de son entreprise, nous découvrirons ce qui le fait vibrer et nous te ferons part de la façon dont AppSumo l'a aidé à faire passer son entreprise à un tout autre niveau.

## Rencontre avec Taylor Hersom de Eden Data

Cette semaine, nous avons parlé à Taylor Hersom, le fondateur d'une société de conseil en cybersécurité et en confidentialité des données qui perturbe l'industrie technologique. Son entreprise, [Eden Data](https://edendata.com/), gère tous les aspects d'une pile technologique de cybersécurité pour les startups en herbe en utilisant un modèle commercial basé sur l'abonnement.

Lorsque Taylor a lancé Eden Data, il s'était retiré de son style de vie rapide de "Big 4 firm" après avoir réalisé qu'il n'y avait pas d'autre endroit où aller que le poste de PDG. Il était déjà l'un des plus jeunes directeurs de la sécurité de l'information (CISO) de l'industrie dans son entreprise, mais il savait qu'il était destiné à quelque chose de plus grand.


Taylor a décidé que s'il voulait vraiment tester ses compétences de RSSI et son propre potentiel, l'entrepreneuriat était la meilleure voie à suivre pour lui. Un an plus tard, Taylor et Eden Data génèrent **120K$ de revenus mensuels récurrents** et prévoient une forte croissance dans le courant de l'année.

## Comment Taylor a trouvé AppSumo

Ce n'est probablement pas une surprise, mais les outils et produits existants dans le monde de la cybersécurité peuvent sembler un peu, eh bien... lents pour une startup technologique au rythme effréné. Ainsi, lorsqu'il s'est agi pour Taylor de trouver des outils pour la pile d'applications d'Eden Data, il savait qu'il devait trouver des solutions plus performantes que ce qui existait actuellement sur le marché.


Taylor a découvert AppSumo en écoutant un épisode du podcast de Sam Parr et Shaan Puri, My First Million, et a décidé de voir de quoi il retournait. Cela faisait des mois qu'il se creusait la tête pour trouver un guichet unique de solutions technologiques approuvées par l'industrie et qui ne donnaient pas à sa startup l'impression qu'elle avait besoin d'une tonalité d'appel.

Ce qu'il a trouvé était encore mieux que ce qu'il aurait pu imaginer. Taylor a parcouru la place de marché AppSumo et a immédiatement essayé une nouvelle application qui était offerte à vie. À partir de là, il est devenu accro. **Plus tard, Taylor se procurera la majorité de la pile technologique d'Eden Data en utilisant la technologie qu'il a achetée sur la place de marché d'AppSumo.

## Arrête d'attendre que la technologie te rattrape

L'un des défis de la création d'une entreprise qui valorise l'innovation est que tu **attends toujours que la technologie te rattrape.** Et pour un fondateur de technologie, il est difficile de savoir si un nouveau produit ou un nouvel outil est de grande qualité ou s'il n'y a que du grésillement et pas de steak.

Mais c'est ce qui rend AppSumo différent. Selon Taylor, la place de marché AppSumo a été la sauce secrète d'Eden Data. Non seulement elle permet de trouver de bonnes affaires, mais elle est aussi sa source privilégiée pour découvrir des solutions technologiques de pointe et savoir ce qui se fait de mieux dans le domaine des logiciels.

> Je dispose maintenant d'un moyen de trouver des applications qui sont nouvelles sur le marché et très innovantes pour résoudre les problèmes de nos clients, tout en créant une expérience unique pour chaque point de contact chez Eden Data."

L'une des façons dont Taylor a pu aider ses clients est de résoudre leurs problèmes souvent uniques et complexes en utilisant les solutions qu'Eden Data construit. En fait, l'un des clients d'Eden Data vient d'entrer dans l'histoire en obtenant un financement de 62 millions de dollars - le plus important jamais accordé à une startup spécialisée dans la fertilité. De plus, cette entreprise prévoit de doubler de taille au cours de l'année prochaine.

Mais si tu demandes à Taylor ce qu'il préfère dans AppSumo, c'est la quantité de choix. L'éventail de logiciels de haute qualité disponibles sur la place de marché permet à chacun de trouver facilement l'outil qui répond à ses besoins. **Taylor dit qu'il est vraiment impressionné par notre capacité à négocier tant d'offres incroyables sur des applications et des logiciels dont il n'aurait jamais eu connaissance sans AppSumo.**

## Que fais-tu de toutes ces économies ?

Un bonus supplémentaire ? Les économies qu'il a trouvées lui ont également donné plus d'argent à réaffecter à ses employés et à de nouvelles initiatives commerciales.  


Taylor définit le succès non seulement en fonction de ses revenus mensuels récurrents de 120 000 $ ou du montant des bénéfices injectés dans l'entreprise, mais aussi en fonction de sa disponibilité à subvenir aux besoins de son équipe.

Pour lui, c'est un tout autre niveau d'accomplissement que de prendre du recul et de se rendre compte que son entreprise ne fait pas seulement vivre sa famille, mais aussi beaucoup d'autres personnes. Certains des événements personnels récents de ses employés comprennent l'achat d'une maison et l'arrivée d'un bébé dans leur famille.


Taylor tient également à s'assurer qu'il reste à la pointe de la technologie dans presque tous les domaines de sa vie de fondateur. Cela inclut également la façon dont il passe son temps.

Je sais que nous avons tous entendu l'expression "le temps, c'est de l'argent", mais je ne savais pas à quel point c'était vrai jusqu'à ce que je devienne entrepreneur", déclare Taylor.

Il jure qu'il pourrait s'acquitter d'une charge de travail complète de 24 heures et ne même pas effleurer la surface de toutes les tâches qu'il doit accomplir. C'est pourquoi Taylor a également investi dans des systèmes et des processus automatisés - à la fois en interne et en contact avec les clients - afin de pouvoir redonner à son équipe autant de temps qu'il est humainement possible de le faire.

> "Nos investissements grâce à AppSumo ont considérablement amélioré notre efficacité, notre visibilité, l'accueil et l'expérience des clients."

Taylor a été en mesure de prendre des tâches subalternes telles que la publication sur les médias sociaux, l'exécution d'une campagne de courriels ou la gestion d'un gros projet client et de les automatiser complètement ou de les rationaliser considérablement. Son secret ? AppSumo.

"Je ne peux pas chiffrer le retour sur investissement que nous avons obtenu en investissant dans AppSumo, mais j'envisagerais fortement d'offrir mon premier enfant en guise de remboursement", déclare Taylor.

## Les outils préférés de Taylor sur AppSumo

Alors, quels sont les outils préférés de Taylor qu'il a trouvés sur AppSumo ? Il a commencé à utiliser [Scribe](https://appsumo.com/products/scribe/), un créateur de signature de courriel, pour transformer les courriels des employés en un nouveau point de contact pour les clients. Eden Data s'est également débarrassé des outils de gestion de projet du passé et utilise désormais [NiftyPM](https://appsumo.com/products/niftypm-2020/).


Comment Eden Data utilise Scribe dans son flux de travail

Eden Data fonctionne également grâce aux témoignages de ses clients. Après avoir cherché dans tous les sens une nouvelle façon de les recueillir, Taylor a découvert [WarmWelcome](https://appsumo.com/products/warmwelcome/) par AppSumo. Il s'agit d'un logiciel simple mais puissant qui permet à Taylor et à son équipe d'entrer en contact avec les clients et d'obtenir des témoignages vidéo pour une touche plus humaine.


WarmWelcome, l'outil d'AppSumo, permet à Eden Data d'entrer facilement en contact avec ses clients.

Et nous ne pouvons pas oublier les médias sociaux ! [Publer](https://appsumo.com/products/publer/) a permis à Eden Data d'automatiser les médias sociaux grâce à la planification et à la collaboration.

Taylor dit qu'il considère AppSumo comme un exemple à suivre pour Eden Data. Il aime notre approche du marché, la clarté de notre image de marque et la personnalisation de nos messages. Il affirme que **le fait d'être activement impliqué dans l'environnement AppSumo l'a aidé à rassembler des dizaines d'idées qui se traduiront par le succès de sa propre entreprise**.


Il a utilisé AppSumo comme point de repère pour sa réussite future et prévoit d'atteindre le niveau de 100 millions de dollars d'AppSumo au cours des trois prochaines années. (Les tacos de célébration sont pour nous, Taylor.)

Qu'est-ce qui se profile à l'horizon pour Taylor Hersom et Eden Data ? Il dit qu'ils travaillent sans relâche pour sortir des sentiers battus. Taylor veut en arriver au point où chaque client dit qu'il veut "l'expérience Eden Data". Et bien sûr, il prévoit d'emmener AppSumo avec lui.


# Making $100K Revenue from AppSumo: Insights and Recommendations
...
LTD stands for Lifetime Deal, and it's the buzzword in the SAAS world. It's a one-time fee for lifelong access to a product. AppSumo, a popular LTD platform, makes over $90 million in Gross Merchandise Value (GMV) annually. If your target audience includes solopreneurs, digital marketing agencies, or marketers, AppSumo could be your launchpad.

However, not all LTDs are created equal. Your product needs to resonate with a broader audience. A good product-market fit is crucial for success.
...
After selling an LTD, a conflict of interest arises. Companies may want users to forget about them, while users expect ongoing improvements. The dynamics of LTDs can be challenging, and managing user expectations is vital.

## Our Learnings

Our journey taught us the importance of community building, the power of FOMO (fear of missing out), the significance of pricing, and the impact of marketplace versus plus exclusive deals. We also stress the importance of being honest, transparent, and prepared for the long term.

## Our 2 Cents for Founders Looking to Do LTDs

- Define clear objectives.
- Be honest and transparent.
- Price your deal with a long-term perspective.
- Seek more visibility on AppSumo.
- Don't oversell your roadmap.
- Collect reviews.
...
- When pricing an LTD, consider the long-term sustainability of your business and how you plan to spend the money generated.
- Chase AppSumo for more visibility and reflect an ending timer to generate FOMO.
- Avoid selling a roadmap that promises features you might not deliver, and collect reviews through in-product messaging.
- Keep your emotions in check when dealing with demanding users, and maintain professionalism.
- Consider leveraging your AppSumo user base for future growth and focus on increasing monthly recurring revenue (MRR).
# We made $100K Revenue on $200K Sales via Appsumo – Our learnings from the campaign!

By: Tanmay Ratnaparkhe
[We made $100K Revenue on $200K Sales via Appsumo - Our learnings from the campaign!](https://predis.ai/resources/we-made-100k-revenue-on-200k-sales-via-appsumo-our-learnings/)
...
1. **Product Validation** – You have just launched a product and want to test the waters. If you want to be in front of a lot of users at the same time and gather feedback fast! Move fast and break things. 
2. **New Market Entry** – You have been operating in a Non-US market and would want to get to the US. The majority of AppSumo users are based in the US and it’s a very good way to test the waters. 
3. **New User outreach** – You have a SAAS product with some traction and would want to increase DAU by reaching out to a new set of users.
4. Raising **Money** – You are looking to raise some money to help you build the next set of features or to start performance marketing 
...
1. **If your product is Transactional in nature** – eg. a form-based product like a CRM, etc, your server costs will only move linearly against exponential new users. If your product has a transactional level cost associated with it – eg. GPT3 based features or email-sending features then you need to factor in the costs being incurred on every transaction. This also means your costs will go up as the users go up / usage goes up. 
2. **How complex is User Onboarding** – Is your product Self Serve or Needs handholding? How complicated are the workflows, can users manage to set up the flow and work themselves? This will broadly decide on how big a support team you will need as users scale up. If the product is self-serve with simple flows, the support team can scale linearly against exponential product usage. Otherwise, you need to factor in larger support costs in the long run.
3. Combining these 2 will give you a per month cost to sustain your user. However, there are more factors involved here.  
4. **What is the Average Customer Lifespan –** Given any product, there will always be an average Customer Lifespan associated with it. It practically never happens that a product is being used forever by a given user – times change/ tastes changes/ tech changes. You need to know the average number of months users will use the product – this will also be needed to calculate the Life Time Value for users at the time of recurring revenues. 
5. Another very important factor is the number of LTD buyers who are actually using the product. This number also depends on how you have priced the LTD – If you have a given ridiculous structure – eg. giving everything unlimited forever, you can expect a lot of sales but a very less % of people actually using the product. In our case, since our pricing was on the higher side, and we are trying to make sure people keep coming back to use our product, we do see a 40% usage rate for our LTDs users. 
...
1. **Limit by Features:** You can decide to offer some features in the base stack and all features in the top stack. This works best if you have some advanced features which might be more useful for agency users. Agency users will typically not mind having the full stack if this is something that will work well for them in the future. 
2. **Increase Feature access non-linearly at multiple stacks:** This is a good way to entice users to buy more codes so that they have access to better limits. Have a look at [this tool](https://appsumo.com/products/heartbeat/) where they have limited access at 1 code and unlimited at 2.
3. **White Label access**: This is a favorite of a lot of agency owners as this helps them make money from your product. A good example will be [Cheatlayer](https://appsumo.com/products/cheatlayer/) where they give white-label access at stacking 10 codes. This costs a cool $1000 to unlock. However if you can show users that they will be able to make much more than their investment, this would be a big win for the users and you!
4. **Unlimited usage:** Though I personally hate this as this is akin to giving the keys to the castle, this does make a lot of sense if your support costs are nil and you are doing the LTD to make money. This is also something that excites the most amount of people and your sales will easily be 3-4X if you are offering unlimited usage forever. However, the flip side is that you will have no leverage to upsell anything later. 
...
2. **Be Honest –** You might be surprised in reading this. But as of now, the bar in the LTD community is set so low that you will gain a lot of supporters if you are just being honest and sincere about your product. Be open and transparent in communication, say no to features you know you won’t build, give extended timelines and then deliver anything faster. 
3. **Price looking at the long term** – It might be tempting to give an unlimited deal and see a lot of traction. Always ask these questions before you price the deal:
    1. How are you planning to spend the money?
    2. Will you be able to convert some of the LTD customers into MRR customers?
    3. Will you be able to leverage LTD users to spread the word about your product?
    4. Will you be able to sustain and actively develop the product for at least 3-5years?
4. **Chase Appsumo for more Visibility-** The key is to be present on the Appsumo main page for as long as possible. If you are a Select deal, this happens. Otherwise, I will suggest chasing the good folks at Appsumo to add you to different lists. Generally, they respond 🙂 Make sure your deal reflects the ending timer as this generates FOMO. 
