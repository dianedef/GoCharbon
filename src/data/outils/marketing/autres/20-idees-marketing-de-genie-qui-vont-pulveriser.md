...
[Swipe-Worthy » Swipe File Archive » Marketing & Copywriting Examples](https://swiped.co/)

[Whatever Happened to Jared Fogle, the Subway Guy? - YouTube](https://www.youtube.com/watch?v=7GzqlCI2dkU) → expérience client témoignage positif

[GIEC : 5 associations inondent un plateau télé pour alerter face à l’urgence climatique – La Réclame](https://lareclame.fr/lespresidents-giec-film-inondation-plateau-tele-277676?utm_source=La+R%C3%A9clame+Newsletter&utm_campaign=0f10cd35ce-la_Rec_Start-230323-dossier-web3&utm_medium=email&utm_term=0_b9409b3e9c-0f10cd35ce-430209213)

# 3-2-1: Loom, Rihanna, Counterintuitive CRO

## Metadata

- Author: Harry from Marketing Examples
- Category: email
- URL: mailto:reader-forwarded-email/71def33e14aa291e21744a09c2d66740

## Highlights

1/ How Loom Created a Category
...
3/ WineList's pricing tiers

99% of pricing tiers ascend left to right: Cheap. Middle. Expensive.

Wine List is the 1%. A mistake? Nope.

Founder, [Josh Lachkovic](https://click.convertkit-mail4.com/p9unqvlzedt9h37w779aq/dpheh0hq3950vmum/aHR0cHM6Ly90d2l0dGVyLmNvbS9Kb3NoTGFjaGtvdmlj) , had a theory:
...
Less “And's” . More “But's” .


2/ Two underrated words in copywriting: “If you...”
...
An interesting new pricing model from

Telfar [LIVE PRICE – shop.telfar](https://telfar.net/collections/live-price?utm_source=substack&utm_medium=email)


. Most brands start the season with high prices and as time goes on sell any extra inventory at a discount. Telfar is starting with its lowest prices, which will rise over time - the opposite of a sale.
...
[Fédération Nationale Solidarité Femmes | Suis-je victime de violences…](https://www.solidaritefemmes.org/suis-je-victime-de-violences-conjugales)

[(2) Insane $2.3 Billion Brand TikTok Strategy - YouTube](https://www.youtube.com/watch?v=wGAzntlAt-g)

- Designer qui ont brisé les règles
    - I don’t remember their name, but there was a famous agency that during the .com bubble created a blank page for their website, with just their direct contact in the footer.
    - It can be considered a positioning hack, since they used the new medium in an unintended way to state their dominance using an understatement. It’s counter intuitive, but it makes sense.
    - In the same way, I see this approach as a positioning hack, because this reflects his values. I need it to be fast, efficient and not over complicated. What’s better than a raw HTML page with just basic info and no graphics?
    - He has all the budget needed to create an award winning website, but it would not have been useful to reinforce his positioning.
    - This one is memorable, and in the crowded overdesigned internet is straight to the point.
    - I would have chosen a different approach probably, but from a branding perspective it makes totally sense, even if it doesn’t look appealing at all
    - ## A
        ...
        - The goal is not to avoid mistakes; but to achieve uncorrelated levels of excellence in some dimension
        - Where do you get your dopamine? The answer is predictive of your behavior
        - We are tied down by invisible orthodoxy

[Jordan Brako - Coaching & Formation en affiliation et SEO](https://jordanbrako.com/)
