...
Reply at light speed with Shortcuts

What we'll learn today

Quickly search through your canned responses

Insert a specific canned response at light speed

Hey there,

Today, we're about to reveal our best kept secret to skyrocket your productivity with typedesk: **Keyboard Shortcuts**!

Quickly search a canned response
...
Sometimes, you'll want to keep your most useful snippets and canned responses at your fingertip. typedesk offers a great feature called **Quick Response Shortcuts**.
...
Template variables are one of the most powerful features on typedesk to create responses that are completely custom and yet super quick to build and to use for your whole team. Variables are located in the right sidebar when editing a canned response.
...
**Dynamic Placeholders** are just what you need to quickly fill in the blanks.

Select a **Text** dynamic placeholder from the right sidebar where you want to insert the contract number, and another one for the missing document.
...
Share canned responses with your team
...
Now that you're familiar with typedesk, **how about getting your team onboard**? Working together ensures your team delivers a **consistent message across the board**! Plus, typedesk can be a time-saver in many departments (Sales, Customer, Marketing, Community Management etc).

Share your canned responses

Are you happy with your canned responses and want to share them with other people? **Simply click on the dots next to any folder in the sidebar, and select "Share"**. You can then send invitations to anyone, giving them read-only or edit rights to the selected folder.

Create collaborative folders

Sometimes, you want to create a **space for your team to collaborate** and edit responses together. **Team folders are a great way to do just that**! Within team folders, people can create and edit responses as much as they want, and keep eveyone on the same page with seamless notifications!
