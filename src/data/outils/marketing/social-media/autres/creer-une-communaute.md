...
author: Diane
description: 'Découvre Créer Une Communauté : outil français pour entrepreneurs, fonctionnalités
  et avis.'
pubDate: '2024-03-25'
...
_Ahum_. Comment dire. Ne partez pas, et donnez-moi une chance de m’expliquer !
...
Alors communauté ou Communauté : comment et pourquoi faire la différence ? Et pourquoi une communauté n’est _**pas**_ une Communauté. 👀

## On parle de Communauté avec un grand C

_Bon ok_. On peut désigner l’ensemble des personnes qui vous suivent en ligne comme une communauté. Mais c’est une communauté avec un petit c.

Ce concept a été formalisé par Commsor, l’entreprise américaine à l’origine de [_The Community Club_](http://the.community.club/), du site [_Community Led_](https://www.communityled.com/the-model/layers-of-community) et de la formation [*C School](https://www.community.club/c-school).*
...
L’objectif de l’acronyme _CAPITAL_ est de mettre en avant différents éléments qui nous indiquent si une communauté en est une au sens de :

> Un groupe de personnes aux intérêts communs, rassemblées en un lieu, qui avancent vers un but similaire.

Chaque lettre correspond ainsi à un élément qui constitue ce type de communauté. Sans entrer dans les détails de chacune d’entre elles (vous pouvez retrouver [l’article en anglais juste ici](https://www.commsor.com/post/what-is-community)), je vous résume les principaux concepts.
...
_Aka quand tu reçois un mail de ta banque qui t’invite dans sa “communauté de bêta-testeurs” pour leur nouvelle app. Pour au final n’avoir 1) qu’une communication unilatérale à base de formulaires, 2) aucune idée de qui sont les autres membres et 3) aucune option pour échanger avec eux._
...
🔹✅💡🥊🛡️🔇🧠📣🎁🏆📚🛠💥🙌😱❌✂️
[Blaze: Unleash Audience Growth with Blaze](https://www.withblaze.app/creator)