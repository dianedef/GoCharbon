...
- Marketing
- Social Media
description: 'Découvre Interessant : outil français pour entrepreneurs, fonctionnalités
  et avis.'
pubDate: '2024-03-25'
...
Face à ces défis, Viginium dispose d’un [arsenal technique impressionnant](https://www.rfi.fr/fr/podcasts/les-dessous-de-l-infox/20240308-viginum-se-muscle-face-%C3%A0-la-recrudescence-des-ing%C3%A9rences-num%C3%A9riques-%C3%A9trang%C3%A8res). Ils collectent des données sur les réseaux sociaux en analysant notamment les métadonnées afin d’identifier les flux massifs d’informations suspectes venant de l’étranger. Par exemple, si un flot soudain de tweets pro-indépendance en Nouvelle-Calédonie provient de comptes basés à l’étranger, c’est un signal d’alarme pour eux. Notez quand même qu’ils ne se posent pas en arbitre de la vérité : leur rôle est simplement de détecter ces anomalies. Leurs alertes permettent ensuite au gouvernement d’étayer ses décisions.
...
Alors évidemment, il est plus que temps de se bouger les fesses et de gueuler un bon coup ! **La Quadrature du Net** est sur le pont et, je le rappelle, a lancé [une grande campagne de mobilisation](https://www.laquadrature.net/wp-content/uploads/vsa/VSA-brochure-planche.pdf) avec plein d’outils pour mettre des bâtons dans les roues de Big Brother. Donc ils comptent sur vous pour relayer à fond, interpeller vos élus, informer vos potes… Bref, ne les laissez pas transformer nos villes en gigantesques [panoptiques](https://fr.wikipedia.org/wiki/Panoptique) !

[Source](https://www.laquadrature.net/2024/05/14/vsa-lassemblee-discute-deja-son-extension-aux-transports/)