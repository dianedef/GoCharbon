...
const FALLBACK_LINKS_BY_CATEGORY: Record<string, string[]> = {
  marketing: ["/marketing/fondamentaux", "/seo/fondamentaux/bases-seo", "/outils/marketing/index"],
  service: ["/biz/freelance/index", "/marketing/social/selling", "/outils/business/autres/crm"],
  tech: ["/biz/saas/index", "/tech/ia/guides/index", "/outils/tech/index"],
  content: ["/marketing/content-marketing", "/contenu/youtube/accelerer-youtube", "/outils/creation/index"],
  ecommerce: ["/biz/e-commerce/index", "/marketing/ads/index", "/outils/ecommerce/index"],
  formation: ["/biz/profils/formation", "/marketing/tunnel/atelier", "/outils/formation/index"],
  general: ["/biz/index", "/marketing/fondamentaux", "/outils/index"],
};
...
const PROFILE_SPECIALIZATION_LINKS: Record<string, string[]> = {
  ...
  agence: ["/biz/freelance/index", "/tutos/trouver-des-prospects-qualifies-pour-votre-agence", "/tutos/implementer-un-gestionnaire-de-relations-clients"],
  "ai-automation": ["/tutos/comment-faire-de-lautomatisation-marketing", "/tutos/comment-faire-de-lautomatisation-pour-grossir-son", "/tech/ia/guides/index"],
  ...
  "amazon-fba": ["/biz/e-commerce/index", "/tutos/generez-vos-descriptions-de-fiches-produits-en", "/marketing/ads/google"],
  "app-developer": ["/biz/saas/index", "/tutos/deployer-un-serveur", "/tutos/comment-creer-un-serveur-de-preprod"],
  ...
  dropshipping: ["/biz/e-commerce/index", "/tutos/shopify-store-qui-font-des-millions", "/marketing/ads/meta"],
  ecommerce: ["/biz/e-commerce/index", "/tutos/comment-importer-des-produits-amazon-dans", "/marketing/ads/meta"],
  ...
  freelance: ["/biz/freelance/index", "/tutos/trouver-des-prospects-qualifies-pour-votre-agence", "/tutos/comment-se-faire-payer-par-ses-clients"],
  ...
  "print-on-demand": ["/biz/e-commerce/index", "/tutos/comment-generer-automatiquement-les-images", "/marketing/ads/meta"],
  "prompt-engineer": ["/tutos/creer-un-custom-gpt-gratuitement", "/tutos/how-to-train-your-own-prompt-on-your-custom-style", "/tech/ia/guides/index"],
  saas: ["/biz/saas/index", "/tutos/comment-creer-saas-avec-espace-membre-avec-notion", "/marketing/analytics/kpis"],
  ...
  "stock-photography": ["/tutos/comment-generer-des-images-en-lots", "/tutos/comment-retirer-un-objet-ou-une-personne-dune", "/outils/creation/index"],
