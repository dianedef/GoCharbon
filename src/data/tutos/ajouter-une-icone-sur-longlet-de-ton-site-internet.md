...
- Tutoriels
imageNameKey: null
title: Ajouter Une Icone Sur L'Onglet De Ton Site Internet
author: Diane
description: 'Découvre Ajouter Une Icone Sur L''Onglet De Ton Site Internet : outil
...
The WP Umbrella TeamOctober 9, 2023


TABLE OF CONTENT

1. [Why You Should Use a WordPress Favicon](https://wp-umbrella.com/tutorials/how-to-add-a-favicon-to-your-wordpress-site/#why-you-should-use-a-wordpress-favicon)
2. [How to Create a WordPress Favicon](https://wp-umbrella.com/tutorials/how-to-add-a-favicon-to-your-wordpress-site/#how-to-create-a-wordpress-favicon)
3. [How to Add a WordPress Favicon to Your Website](https://wp-umbrella.com/tutorials/how-to-add-a-favicon-to-your-wordpress-site/#how-to-add-a-wordpress-favicon-to-your-website)
4. [Do not use a plugin to add a site icon!](https://wp-umbrella.com/tutorials/how-to-add-a-favicon-to-your-wordpress-site/#conclusion)

- SHARE ON:
- [](http://www.facebook.com/sharer.php?u=https://wp-umbrella.com/tutorials/how-to-add-a-favicon-to-your-wordpress-site/)
- [](http://www.linkedin.com/shareArticle?mini=true&url=https://wp-umbrella.com/tutorials/how-to-add-a-favicon-to-your-wordpress-site/)
- [](https://twitter.com/share?url=https://wp-umbrella.com/tutorials/how-to-add-a-favicon-to-your-wordpress-site/)
...
You can use [Canva](https://www.canva.com/) to create a site icon that has an exact size of 512×512 pixels. Your image will therefore remain in a precise proportion. It is possible to use a transparent image or to fill the image with a color of your choice. You can use a gif, jpeg, or png image. [](https://kinsta.com/knowledgebase/wordpress-favicon/#how-to-create-a-wordpress-favicon)

Last but not least, you should review the [Google Guidelines for creating and using favicon](https://developers.google.com/search/docs/advanced/appearance/favicon-in-search). This will make the icon display optimally in search engines and browser tabs, which is your ultimate goal!
...
It’s also possible to add your WordPress Favicon with the [plugin Favicon](https://wordpress.org/plugins/favicon-by-realfavicongenerator/). However, since it’s now possible to do it directly with WordPress, we advise you not to do it.
