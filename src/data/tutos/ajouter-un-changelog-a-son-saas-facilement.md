...
imageNameKey: null
u_site: null
title: Ajouter Un Changelog À Son Saas Facilement
author: Diane
description: 'Découvre Ajouter Un Changelog À Son Saas Facilement : outil français
  pour entrepreneurs, fonctionnalités et avis.'
pubDate: '2024-03-25'
imgUrl: ../../assets/astro.jpeg
---

# Ajouter Un Changelog A Son SaaS Facilement

## CHANGELOG : LA VITRINE DE TES MISES A JOUR

### tl;dr

Un changelog liste toutes les mises a jour de ton produit. Ca parait basique, mais c'est un outil puissant de retention, de transparence et de marketing. Tes utilisateurs voient que ton produit evolue, tes prospects voient un projet actif. Ce tuto te montre comment en mettre un en place en moins d'une heure.

---

## Pourquoi un changelog est indispensable

- **Retention** -- Tes users voient que tu ameliores le produit
- **SEO** -- Chaque mise a jour = contenu frais indexable
- **Marketing** -- "10 nouvelles fonctionnalites ce mois-ci" est un argument de vente concret
- **Support** -- Au lieu de repondre "c'est corrige", tu partages le lien

## Que mettre dans un changelog

Chaque entree : date, titre descriptif, type (New/Improved/Fixed/Removed), description courte, et un visuel quand c'est pertinent.

## Option 1 : Getlog (le plus simple)
...
**Prix :** Plan gratuit. Payant a partir de 9 $/mois pour le widget.

## Option 2 : Canny (changelog + feedback)

Canny combine changelog, feedback utilisateur et roadmap publique.

1. Cree ton compte sur [canny.io](https://canny.io)
2. Configure le changelog
...
Specialise dans le widget avec badge de notification.

1. Inscris-toi sur [headwayapp.co](https://headwayapp.co)
2. Cree tes entrees, integre le widget (badge "Nouveautes" avec compteur)
3. Les users voient les updates sans quitter ton app

**Prix :** Plan gratuit disponible. Payant a partir de 29 $/mois (selon les comparatifs). Note : ne pas confondre avec l'app "Headway" de resumes de livres qui est un produit totalement different.
...
3. Integre le widget in-app (badge "Nouveautes", bannieres, tooltips)
...
**Avec GitHub Releases :** Chaque release contient les notes de version. Ideal pour les projets open-source.

**Page statique :** Un fichier changelog.html avec des sections par date.

## Comment bien rediger

**Mauvais :** "Bug fix sur le dashboard"
...
- **Publie chaque semaine** ou toutes les 2 semaines
- **Email mensuel** "What's New" via ton outil d'emailing
- **Poste sur LinkedIn** quand une feature majeure sort
- **Integre dans l'onboarding** pour montrer que le produit est vivant

## Astuces GoCharbon

- **Un changelog actif = preuve sociale.** 20 updates ce mois vs 0 chez le concurrent = avantage enorme.
