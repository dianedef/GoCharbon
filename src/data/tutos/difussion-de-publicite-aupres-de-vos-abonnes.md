...
imageNameKey: null
u_site: null
title: Difussion De Publicité Auprès De Vos Abonnés
author: Diane
description: 'Découvre Difussion De Publicité Auprès De Vos Abonnés : outil français
...
3. Choisis **Liste de clients**
4. Importe ton fichier CSV
5. Facebook fait le matching : il compare les emails de ta liste avec ceux des comptes Facebook/Instagram

**Taux de correspondance typique** : 40 a 70%. C'est normal que tout le monde ne matche pas (emails pro, adresses qui ne sont pas liees a un compte Facebook).

**Mise a jour** : ta liste n'est pas synchronisee automatiquement. Reimporte-la tous les mois pour garder l'audience a jour. Certains outils comme Brevo ou Mailchimp ont des integrations directes avec Meta qui synchronisent automatiquement.
...
3. Choisis le pays cible (France)
4. Choisis la taille : 1% (plus precise, ~450 000 personnes en France) a 10% (plus large, ~4 500 000 personnes)

**Bonnes pratiques :**
- Utilise ta liste de clients (pas toute ta newsletter) comme source pour de meilleurs resultats
- Commence par 1% pour tester, puis elargis a 2-3% si ca fonctionne
...
1. Va dans Google Ads > Outils > **Gestionnaire d'audiences**
2. Clique sur le + > **Liste de clients**
3. Importe ton CSV (emails, telephones, ou les deux)
...
|----------|----------------------|-----------|-----------------|
| CPC moyen | 0.30-0.80 euros | 0.50-1.50 euros | 1.00-3.00 euros |
...
- [Meta Business Manager - Audiences](https://business.facebook.com/adsmanager/audiences) -- creer des Custom Audiences et Lookalikes
- [Google Ads - Customer Match](https://support.google.com/google-ads/answer/6379332) -- guide officiel Google, minimum abaisse a 100 en 2025
- [Brevo - Integration Meta](https://www.brevo.com/integrations/) -- synchronisation automatique de listes
- [Mailchimp - Meta Integration](https://mailchimp.com/integrations/facebook/) -- synchronisation automatique
- [Klaviyo](https://www.klaviyo.com) -- excellent pour l'e-commerce avec sync native Meta et Google
- [LeadsBridge](https://leadsbridge.com) -- automatisation de la sync d'audiences entre CRM et Meta/Google
