...
imageNameKey: null
u_site: null
title: Détecter Un Contenu Généré Par Ia
author: Diane
description: 'Découvre Détecter Un Contenu Généré Par Ia : outil français pour entrepreneurs,
  fonctionnalités et avis.'
pubDate: '2024-03-25'
imgUrl: ../../assets/astro.jpeg
---

[Comment Éviter la Détection de ChatGPT et Humaniser vos Textes en 60 Secondes ! - YouTube](https://www.youtube.com/watch?v=UsPe8KMQaGc)


[ai text classifier - Recherche Google](https://www.google.com/search?q=ai+text+classifier&sourceid=chrome&ie=UTF-8)
...
- Il est limité à ce qu’on lui a appris
- Il peut uniquement produire ce qu’il a déjà vu
- Il ne peut pas produire du contenu frais, actuel, il s’arrête à 2021

Il résoud un gros pain point car la barrière d’entrée pour la création de contenu est haute : Le bon contenu prend du temps et nécessite de l’expertise donc ceux qui n’ont ni le temps ni l’argent… Donc avoir un AI writer est top car il rend ça accessible, mais on ne veut pas que les gens puissent raconter n’importe quoi donc maintenant on fait quoi ?

## QU’est ce que Google en pense ?
...
Mais ChatGPT est nul pour faire de l’expertise et de l’autorité, il se trompe souvent

## Quand peut-on l’utiliser pour le SEO ?

Surtout pour les tâches créatives, se donner des idées, si t’es concé writer’s block

Les tâches ,structurantes : Résumer un paragraphe, les choses vues et revues la science commune (ex les pneus de neiges)

- Il est confiné à faire de la paraphrase, de la réécriture, de remâché, du contenu court type heading et description
- plus tu lui demande de choses plus, le risque de produit du contenu inexact et insensé augmente dramatiquement
- duplicate content
...
[(5) 4 outils incroyables pour interagir avec des IA - Alternative gratuite à Midjourney et Dall-e2 + API - YouTube](https://www.youtube.com/watch?v=6bybbMkHtgI)
...
Best sources to check AI content against to see if it reads as human vs AI? Any recommendations?

- [**Carl Angelo Tardecilla**]([https://www.facebook.com/groups/370711310583143/user/100000143847207/?__cft__[0]=AZWKzrUDgBNtkdq8DyqaVF_8GjqvK5-7jzIETRkDV2jHxr3X_IkGM5IBQlaxJmXK7ZwN5GC4IX_EfBAOM5nqDxzpLB9FPnO4mh6IwfMy6f__t9AGePhQ1dcRMuogCqJUctI_fxNM4lJ3AZi1smJk1C5OzdGk-w_jj8SCqVkiSl-sVJRx79RCgFy1-FQl7PRCQCY&__tn__=R](https://www.facebook.com/groups/370711310583143/user/100000143847207/?__cft__%5B0%5D=AZWKzrUDgBNtkdq8DyqaVF_8GjqvK5-7jzIETRkDV2jHxr3X_IkGM5IBQlaxJmXK7ZwN5GC4IX_EfBAOM5nqDxzpLB9FPnO4mh6IwfMy6f__t9AGePhQ1dcRMuogCqJUctI_fxNM4lJ3AZi1smJk1C5OzdGk-w_jj8SCqVkiSl-sVJRx79RCgFy1-FQl7PRCQCY&__tn__=R)]-R)
...
- Does it work?
- What does it mean for us Jaspernauts?
- Will Google implement similar technology?
...
[0:00](https://www.youtube.com/watch?v=BMg6mlKkW6U&t=0s)

| Introduction

[1:16](https://www.youtube.com/watch?v=BMg6mlKkW6U&t=76s)

| [Originality.ai](http://Originality.ai) - Ai Content Detection Software

[2:21](https://www.youtube.com/watch?v=BMg6mlKkW6U&t=141s)

| Testing Un-Edited Jasper Content

[5:30](https://www.youtube.com/watch?v=BMg6mlKkW6U&t=330s)

| Testing My Jasper-Assisted Published Content

[6:26](https://www.youtube.com/watch?v=BMg6mlKkW6U&t=386s)

| Testing 100% Human-Written Content

[7:50](https://www.youtube.com/watch?v=BMg6mlKkW6U&t=470s)

| What Does AI Content Software Mean for Jasper Users?

[10:10](https://www.youtube.com/watch?v=BMg6mlKkW6U&t=610s)

What does this mean for us Jaspernauts? And this goes back to what I've been saying from

the beginning, which is that Jasper is designed to be a writing assistant. Assistant. Go ahead

and use him to crank out those rough drafts, but you've got to take that raw output and make

something with it. Right, you're the sculptor, Jasper is the clay. So again, you can see from

the scans of my blog posts that the a detection score is quite low, comparable to some of my even

fully human-written content. And that's because I add my own insights, ideas, and rephrase things

in a way that I would say them. But let's get to what this is really about, which is what Google

thinks about all this. Because if a tool like this exists now, it stands to reason that Google could

Implement something similar in an upcoming update. But you've got to remember that with Google,

it always comes back to creating high-quality content. With them, it's not about if an AI

wrote it or a human wrote it. What matters most is that it's valuable content. They even say as much

in their spam policies, which I'll link to in the description box for you to read at your leisure.

But I'll draw your attention to this passage in particular, which is: "Spammy automatically

generated (or Auto-generated content) is content that's been generated programmatically

without producing anything original or adding sufficient value. Instead, it has been generated

for the primary purpose of manipulating search engines and not helping users." That's the key,

right? Without producing anything original, without adding sufficient value. I'll also draw

your attention to an article published and Wired back in April, which I'll also link to below,

and it talks about the future in content marketing and AI, and it's a really great read, but one

specific passage that I want you to read is this: "Danny Sullivan, Google's public search liaison,

says that more sophisticated writing tools that can suggest large chunks of text shouldn't harm

a Page's ranking if used to genuinely help web Surfers. 'If the primary purpose of the

content is for the users, it shouldn't fall afoul of our guidelines,' he says. 'If it's

the best and most helpful content, then ideally we should be showing it.'" So, having read that,

it stands to reason that even if Google implements AI-detecting software when they crawl in index

websites, it won't really make a difference provided its high-quality, valuable content.

So here's the bottom line to all of this: the arrival of this tool changes nothing, at least not

for how I've been using Jasper. My recommendation is that if you're using Jasper AI to help you

create your content, make sure that you're editing those outputs and making the content your own. But

there's no need to panic about the fact that this tool exists - rather, we can actually

use this tool to our advantage by checking to see how unique our content is before we publish

it. If you want to check out

[Originality.ai](http://originality.ai/)

, you'll find a referral Link in the description

[(7) Chat GPT VS Google AI Detection ( SEO Test 2023 ) - YouTube](https://www.youtube.com/watch?v=-uTmjBvRvlo)

[(7) Google Ads Blocked Open AI's Chat GPT (Case Study) - YouTube](https://www.youtube.com/watch?v=FY2b1eLiI5k)

jasper

with their 125 mil in funding they just got, it better be good.

[(1) Top 3 AI Detection Tools: Full Test with Top AI Writers - YouTube](https://www.youtube.com/watch?v=-CrvU5OEjpA)