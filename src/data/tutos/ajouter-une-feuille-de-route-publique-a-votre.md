...
imageNameKey: null
u_site: null
title: Ajouter Une Feuille De Route Publique À Votre Site Internet Ou Application
author: Diane
description: 'Découvre Ajouter Une Feuille De Route Publique À Votre Site Internet
  Ou Application : outil français pour entrepreneurs, fonctionnalités et avis.'
pubDate: '2024-03-25'
imgUrl: ../../assets/astro.jpeg
---

# ROADMAP PUBLIQUE : MONTRE A TES UTILISATEURS CE QUI ARRIVE

Une roadmap publique, c'est une page ou tes utilisateurs voient ce que tu construis, ce qui est prevu, et ce qui est termine. Ca cree de la transparence, de la confiance et de l'engagement. Les meilleurs SaaS l'utilisent (Linear, Notion, Stripe). Voici comment en creer une pour ton produit.

## Pourquoi avoir une roadmap publique

### Pour tes utilisateurs
- Ils voient que le produit evolue activement
- Ils peuvent voter sur les fonctionnalites qui les interessent
- Ils se sentent ecoutes quand leur suggestion apparait sur la roadmap
...
2. Configure tes **boards** (categories) : "Feature Requests", "Bug Reports", "Integrations"
3. Definis les **statuts** : Ouvert, Planifie, En cours, Termine
...
**Prix (2025)** : Canny a abandonne ses anciens plans a prix fixe pour un modele base sur l'usage (nombre d'utilisateurs "tracked", c'est-a-dire ceux qui interagissent avec tes boards) :
...
### Comparatif rapide des outils payants

| Outil | Prix depart | Modele de tarification | Roadmap | Votes | Changelog | Point fort |
|-------|-------------|----------------------|---------|-------|-----------|------------|
...
*Beamer : le feedback/votes est un add-on payant (99 USD/mois en plus).

## Les alternatives gratuites

### Trello -- Board public gratuit
...
Si ton produit est open source ou tech :
1. Cree un Project sur ton repo GitHub
2. Configure les colonnes (Backlog, In Progress, Done)
3. Les issues deviennent des items de roadmap
4. Les utilisateurs peuvent commenter et reagir avec des emojis (ca sert de vote)

**Prix** : gratuit.

### Notion -- Page publique

1. Cree une base de donnees Notion avec les colonnes : Feature, Statut, Priorite, Votes
2. Ajoute une vue **Board** (kanban)
3. Clique sur **"Partager" > "Publier sur le web"**
4. Integre le lien sur ton site

**Limites** : pas de vote interactif (sauf via un formulaire externe), chargement lent.

## Comment structurer ta roadmap
...
### Les informations par item

- **Titre clair** : "Integration Zapier" (pas "webhook system v2")
- **Description courte** : 1-2 phrases qui expliquent le benefice utilisateur
- **Nombre de votes** : les utilisateurs voient la demande populaire
- **Estimation** (optionnel) : T1 2025, Q2 2025... pas de dates precises (ca cree des attentes)

### Ce qu'il ne faut PAS mettre

- **Pas de dates de livraison exactes** -- tu vas les rater et les utilisateurs seront decus
- **Pas de details techniques** -- les utilisateurs veulent savoir "quoi", pas "comment"
- **Pas de fonctionnalites confidentielles** -- si un concurrent peut te copier, garde-le interne
...
```
## [1.5.0] - 12 janvier 2025

### Nouveau
- Integration Zapier pour automatiser vos workflows
- Export CSV des donnees

### Ameliore
- Vitesse de chargement du dashboard (+40%)
- Meilleur affichage sur mobile

### Corrige
- Bug d'affichage sur la page de facturation
```
