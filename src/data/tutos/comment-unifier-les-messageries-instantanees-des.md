...
imageNameKey: null
u_site: null
title: Comment Unifier Les Messageries Instantanées Des Réseaux Sociaux
author: Diane
description: 'Découvre Comment Unifier Les Messageries Instantanées Des Réseaux Sociaux
...
**Configuration** :
1. Cree un compte sur [crisp.chat](https://crisp.chat/fr/)
2. Installe le widget de chat sur ton site (un bout de code JavaScript a coller avant `</body>`)
3. Va dans **Parametres > Messagerie > Integrations**
4. Connecte tes comptes : Facebook (pour Messenger + Instagram), WhatsApp Business, email
5. Tous les messages arrivent dans l'onglet **"Boite de reception"**

**Prix (2025)** : Crisp a revu ses tarifs. Les plans sont factures par workspace (pas par agent), mais chaque plan a un nombre de sieges limite :
- **Free** : 2 operateurs, chat site web basique
- **Mini** : 5 EUR/mois/workspace -- pas de limite de conversations
- **Essentials** : 29 EUR/mois/workspace -- integrations multicanal (Messenger, Instagram, WhatsApp, email)
...
**Configuration** :
1. Cree un compte sur tidio.com
2. Choisis ta plateforme (WordPress, Shopify, Wix, ou code custom)
3. Installe le plugin/widget
4. Connecte Messenger et Instagram depuis les parametres
5. Configure les reponses automatiques pour les questions frequentes

**Prix (2025)** : Tidio facture par nombre de conversations facturables :
- **Free** : 0 EUR -- 10 sieges, live chats illimites, 50 conversations chatbot/mois
- **Starter** : 29 USD/mois -- 100 conversations facturables/mois, analytics, liste de visiteurs en temps reel
- **Growth** : a partir de 59 USD/mois -- 250+ conversations/mois, analytics avances, routage avance
...
**Canaux supportes** : email, chat, telephone, Messenger, Instagram, WhatsApp, Twitter/X, formulaire web.
...
### 1. Liste tes canaux actifs

Avant de choisir un outil, fais l'inventaire :
- Sur quels canaux tes clients te contactent-ils ?
- Quels canaux tu veux ouvrir (WhatsApp, Instagram DM...) ?
- Combien de personnes doivent repondre ?

### 2. Connecte tes comptes
...
Cree des templates pour les questions frequentes :
...
- Notification desktop pour les nouveaux messages
