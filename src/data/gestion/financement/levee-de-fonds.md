...
- Business Angels : 10K-100K euros
...
- Fonds d'amorcage : Kima Ventures, Daphni, Breega
- BPI France (via des dispositifs de co-investissement)

**Ce que les investisseurs attendent :**
- Product-market fit en cours de validation
- 10K-100K euros de MRR (Monthly Recurring Revenue) pour un SaaS
- Traction mesurable (croissance mois sur mois de 15-20%)
- Un business model clair

**Valorisation typique :** 2M - 10M euros.

### Serie A (3M - 15M euros)

**Quand ?** Tu as prouve ton business model, tu generes du revenu recurrent et tu veux accelerer.

**Qui investit ?**
- Fonds VC (Venture Capital) : Partech, Elaia, Idinvest, Eurazeo
- Fonds corporate

**Ce que les investisseurs attendent :**
- Product-market fit confirme
- 100K-500K euros de MRR
- Croissance de 100%+ par an
- Unit economics saines (LTV/CAC > 3)
- Plan d'execution clair pour les 18-24 prochains mois

**Valorisation typique :** 10M - 50M euros.

### Serie B (15M - 50M euros)

**Quand ?** Tu as un modele qui marche, tu veux scaler agressivement (international, nouveaux produits, recrutement massif).
...
**Ce que les investisseurs attendent :**
- Revenus > 5M euros/an
- Croissance de 80%+ par an
- Position de leader ou top 3 sur ton marche
- Capacite a s'internationaliser

**Valorisation typique :** 50M - 200M euros.
...
La valorisation, c'est le prix de ton entreprise. Quand un investisseur met 1M euros dans ta boite valorisee 4M euros en pre-money, la valorisation post-money est de 5M euros et l'investisseur detient 20%.

**Valorisation pre-money :** combien vaut ta boite AVANT l'investissement.

**Valorisation post-money :** pre-money + montant leve.
...
**Valorisation et montant :** Le prix de tes parts et le montant investi.

**Liquidation preference :** En cas de vente, les investisseurs recuperent leur mise en premier. Une preference 1x est standard. Mefie-toi du 2x ou 3x (l'investisseur recupere 2 ou 3 fois sa mise avant que tu touches quoi que ce soit).

**Anti-dilution :** Protege les investisseurs si tu leves a une valorisation inferieure au tour precedent (down round). La methode "weighted average" est plus juste que la methode "full ratchet".

**Drag-along :** Permet aux actionnaires majoritaires de forcer la vente. Standard, mais negocie le seuil (66% ou 75%).
...
### Ce qu'il faut negocier en priorite

1. La valorisation (evidemment)
...
Une fois le term sheet signe, les investisseurs vont fouiller ta boite sous toutes ses coutures pendant 4-8 semaines.

### Ce qu'ils vont verifier

**Legal :**
- Statuts et pacte d'actionnaires
- Propriete intellectuelle (brevets, marques, code source)
- Contrats en cours (clients, fournisseurs, employes)
- Litiges eventuels
...
|---|---|---|---|
| Kima Ventures | Seed | 150K euros | Generalist (500+ investissements) |
| Daphni | Seed/A | 1-5M euros | Tech, SaaS |
| Partech | Seed/A/B | 1-15M euros | Tech, digital |
| Elaia | Seed/A | 500K-5M euros | Deep tech |
| Eurazeo | A/B/C | 5-50M euros | Growth |
| Breega | Seed/A | 500K-5M euros | Tech, impact |
| Idinvest | A/B | 1-15M euros | Software, digital |

## Le pitch deck : convaincre en 15 minutes
...
12. **Le contact :** comment te joindre
...
| Negociation | 2-4 semaines | Term sheet, discussion des termes |
| Due diligence | 4-8 semaines | Verification des documents, audits |
...
Lever n'est pas toujours la meilleure option. Compare avec les alternatives :
...
- [Bootstrapping](/gestion/financement/bootstrapping) -- L'alternative sans dilution
- [Crowdfunding](/gestion/financement/crowdfunding) -- Financer par la foule
- [Subventions](/gestion/financement/subventions) -- Les aides publiques
- [Gestion financiere](/gestion/financement/finances) -- Les fondamentaux
- [Business plan](/performance/plan/business-plan) -- Structurer ton projet
- [Analyse de marche](/performance/plan/analyse-marche) -- Dimensionner ton marche
