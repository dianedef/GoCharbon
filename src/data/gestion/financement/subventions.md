...
L'ACRE est probablement l'aide la plus connue et la plus automatique.
...
**Conseil :** si ton business necessite un investissement initial (stock, materiel, local), choisis l'ARCE. Si tu lances une activite de service sans frais, le maintien de l'ARE est souvent plus securisant.
...
**Bourse French Tech :**
- Subvention de 10 000 a 30 000 euros
- Pour valider un concept innovant (prototype, etude de marche)
- Pas de remboursement

### France Num : la transformation digitale

France Num aide les TPE et PME a se digitaliser avec des dispositifs concrets.

**Cheque France Num :**
- Aide financiere de 500 euros pour se former au numerique
- Formation, conseil ou accompagnement
- Accessible a toutes les TPE

**Activateurs France Num :**
- Accompagnement gratuit par des experts du numerique
- Diagnostic digital de ton entreprise
- Recommandations personnalisees

**Pour qui ?** Si tu es une TPE ou PME de moins de 250 salaries et que tu veux developper ta presence en ligne, automatiser tes processus ou lancer un e-commerce.

### Le Credit d'Impot Recherche (CIR)
...
- Brevets et licences
- Veille technologique (plafonne a 60 000 euros)

**Montant moyen :** les PME recuperent en moyenne 40 000-80 000 euros par an de CIR.

**Attention :** le CIR fait l'objet de controles fiscaux frequents. Documente scrupuleusement tes travaux de R&D et fais-toi accompagner par un cabinet specialise.

### Le Credit d'Impot Innovation (CII)
...
## Les aides regionales : un tresor cache

Chaque region a ses propres dispositifs d'aide. C'est souvent la que se trouvent les financements les plus accessibles et les moins connus.

### Ile-de-France

- **PM'up :** subvention de 30 000 a 250 000 euros pour les PME en croissance
- **Innov'up :** aide a l'innovation de 20 000 a 500 000 euros
- **TP'up :** aide aux TPE de 10 000 a 20 000 euros pour se moderniser
...
- **Croissance Industrie :** aide aux investissements industriels
...
### Horizon Europe (le gros programme)

Le programme de recherche et innovation de l'UE, avec un budget de 95,5 milliards d'euros sur 2021-2027.

**Pour qui ?** Startups et PME innovantes, en partenariat avec des acteurs europeens.

**EIC Accelerator :** Le dispositif phare pour les startups.
...
- Gere au niveau regional
- Finance les investissements productifs des PME
- Jusqu'a 50% de cofinancement
- Accessible via les appels a projets regionaux
...
### Les 5 elements d'un dossier gagnant

**1. Le resume executif (1 page)**
- Qui tu es
- Ce que tu fais
...
**Erreur 5 : negliger le suivi.** Si tu obtiens une subvention, tu as des obligations de reporting. Garde toutes tes factures, documente l'avancement et respecte les jalons.
...
| Aides regionales | Variable (appels a projets trimestriels en general) | 2-6 mois |
...
- CIR/CII : 30 000-120 000 euros/an
- Aide a l'innovation BPI : 100 000-500 000 euros
- FEDER ou EIC pour l'international
- **Total cumule : 300 000+ euros**
...
- [Bootstrapping](/gestion/financement/bootstrapping) -- Financer avec tes propres moyens
- [Crowdfunding](/gestion/financement/crowdfunding) -- Le financement participatif
- [Levee de fonds](/gestion/financement/levee-de-fonds) -- Quand tu vises plus gros
- [Gestion financiere](/gestion/financement/finances) -- Les bases de la finance
- [Business plan](/performance/plan/business-plan) -- Construire un dossier solide
